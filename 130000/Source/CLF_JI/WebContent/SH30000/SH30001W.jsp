...
<script type="text/javascript" src="../scripts/SH30000/SH30001W.js"></script>
...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
  <tr>
    <td align="left" valign="top">		
		<form id="editForm" action="EXECSH30001.action" method="post">
        <div id="apDiv1">
		...
		状态符号说明：
		<img src="../images/ico/0.gif" title="<s:property value="%{getText('app.sjsh.sh00000.unknown')}" />" alt="<s:property value="%{getText('app.sjsh.sh00000.unknown')}" />"/>
		<img src="../images/ico/11.gif" title="<s:property value="%{getText('app.sjsh.sh00000.warning')}" />" alt="<s:property value="%{getText('app.sjsh.sh00000.warning')}" />"/>
      ...
      <div class="divbottom">
        <a href="javascript:void(0)" onClick="document.getElementById('hidFlag').value='1';AppSubmit();">
          <img src="../images/ico/Add.gif" width="16" height="16" title="<s:property value="getText('app.sjsh.sh00000.button.sh')"/>" alt="<s:property value="getText('app.sjsh.sh00000.button.sh')"/>" /><s:property value="getText('app.sjsh.sh00000.button.sh')"/>
        </a>
        <a href="javascript:void(0)" onClick="document.getElementById('hidFlag').value='2';AppSubmit();">
          <img src="../images/ico/Add.gif" width="16" height="16" title="<s:property value="getText('app.sjsh.sh00000.button.shAll')"/>" alt="<s:property value="getText('app.sjsh.sh00000.button.shAll')"/>" /><s:property value="getText('app.sjsh.sh00000.button.shAll')"/>
        </a>	
      </div>
</td>
  </tr>
