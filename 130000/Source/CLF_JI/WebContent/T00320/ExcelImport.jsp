...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
  <tr>
	...
	<form action="../sjcj/QMPGLRIMPORT.action" method="post" id="editForm" enctype="multipart/form-data">
		...
		<span id="imgUpload" style="display:none"><img src="../scripts/easyui/themes/default/images/pagination_loading.gif"/>正在上传数据...</span>
			...
			<!--  <a href="javascript:void(0)" onclick="AppSubmit();" class="easyui-linkbutton" plain="true" iconCls="icon-upload"><span class="icon-upload" style="width:20px;height:7px;padding-top:3px;"></span>数据导入</a>-->
		</div>
		</div>
	</div>
</td>
