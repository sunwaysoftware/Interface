...
<script type="text/javascript" src="../scripts/T00320/VIEWT003201.js"></script>
		...
		frozenColumns:[[
                  {title:'<input type="checkbox" name="chkSelAll" id="chkSelAll" class="rootCheck radio" value="true"/>',field:'checkbox',width:30,align:'center',formatter:function(value,rec){
                   ...
                   {title:'操作',field:'edit',width:40,align:'center',formatter:function(value,rec){
	   					if (rec.fcid!=null)
	   						return "<a href=ADDT00320.action?ACT=U&TSIGN=3201&FCID=" + rec.fcid + "><img src=\"../images/ico/Edit.gif\" title=\"编辑\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a><a href=ADDT00320.action?ACT=D&TSIGN=3201&FCID=" + rec.fcid + "><img src=\"../images/ico/Delete.gif\" title=\"删除\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
	   					else
	   						return "";
<!--	   				}},-->
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
              <span class="datagrid-title-text"><s:property value="%{getText('app.sjcj.t003201.title')}" /></span>
			</div>
