...
<s:else>
	...
	<p>父节点： <s:iterator value="navList" id="navEntity" status="index">
		<s:if test="!#index.last">
			<a href="javascript:void(0)" onclick="getInfoData('<s:property value="rootid"/>','<s:property value="infoid"/>','<s:property value="PARENTID"/>','','')" >
			...
			<ul>
				<li>
					<input type="radio" class="radio" name="rdoPARENT" id="rdoPARENT" value="<s:property value="infoid"/>" 
                        ...
                        <a href="javascript:void(0)" title="<s:property value="note"/>" onclick="getInfoData('<s:property value="rootid"/>','<s:property value="infoid"/>','<s:property value="PARENTID"/>','')"><s:property value="infonm" /></a>
				</li>
			</ul>
		</s:else>
	</s:iterator>
