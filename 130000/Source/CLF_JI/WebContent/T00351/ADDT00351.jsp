...
<table border="0" align="left" cellpadding="0" cellspacing="0"
	...
	<div class="datagrid-title">
		<span class="datagrid-title-text"><s:property
				value="%{getText('app.xtwh.t00351.title')}" /></span>
	</div>		
		...
		<input type="hidden" name="isClocktZT" id="isClocktZT" value="0"></input> 
		<s:if test='%{FROM=="U"}'>
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
		    			...
		    			<tr>	                        
                        	<td width="350">
								...
								<span class="txtInfonm txtfocus"><input name="txtFWLXTIP" id="txtFWLXTIP" type="text" value="<s:property value="tBean.fwlxsc" />" readonly="readonly"  /><span id="spFWLX"></span></span><input type="hidden" id="txtFWLX" name="txtFWLX" <s:if test='%{txtFale != "1"}'>value="<s:property value="tBean.cd00001Fwlx" />"</s:if>/>
					        </td>
					    		...
					    		<table width="100%" border="0" cellspacing="2" cellpadding="0">
								  	...
								  	<tr>
										<td><label class="labelA">
										    ...
										    <span class="txtInfonm txtfocus"><input name="txtXQTIP" id="txtXQTIP"  value="<s:property value="v00303Bean.xqnm"/>" type="text" readonly="readonly" <s:if test='%{ACT == "D"}'>disabled="disabled"</s:if> /><span<s:if test='%{ACT!="D"}'> id="spXQDM"</s:if>></span></span><input type="hidden" id="txtXQDM" name="txtXQDM" <s:if test='%{ACT=="D"}'>disabled="disabled"</s:if> <s:if test='%{txtFale != "1"}'>value="<s:property value="v00303Bean.cd00352Xqdm" />"</s:if>/>
										</td>
									</tr>
									<tr>
									    <td><label class="labelA"><s:property value="getText('app.xtwh.t00351.pfmjg')" /></label> 
...
<!--							  	<span class="txtInfonm txtfocus"><input name="txtJYLXTIP" id="txtJYLXTIP" type="text" value="<s:property value="tBean.jylxsc" />" readonly="readonly"  /><span id="spJYLX"></span></span><input type="hidden" id="txtJYLX" name="txtJYLX" value="<s:property value="tBean.cd00001Jylx" />"/>-->
<!--						  	</td>-->
<!--						  	<td>-->
<!--						  	</td>-->
<!--					  	</tr>-->
...
<!--				</table>-->
		...
		<div class="divbottom">
			<div><a href="javascript:AppSubmit();"><img src="../images/ico/Update.gif" width="16" height="16" title="<s:property value="getText('app.button.save')"/>" alt="<s:property value="getText('app.button.save')"/>" /><s:property value="getText('app.button.save')" /></a> <a href="VIEWT00351.action"><img
