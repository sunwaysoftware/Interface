...
function BindDate(){
	$('#tab').datagrid({					
		...
		columns:
	   [[  
           {field:'ssgx',title:'税收管辖',rowspan:2,align:'center',width:80},  
           ...
           {field:'xtpg',title:'系统评估',rowspan:2,align:'right',width:80,formatter:function(value, rec){
        	   return formatNumber(value, '#,##0');
           }},
           {field:'gapg',title:'个案评估',rowspan:2,align:'right',width:80,formatter:function(value, rec){
        	   return formatNumber(value, '#,##0');
           }},
           ...
           {field:'sehjzjl',title:'增减率',width:80,align:'right',formatter:function(value, rec){
        	   return formatNumber(value, '#,##0.00');
           }}
