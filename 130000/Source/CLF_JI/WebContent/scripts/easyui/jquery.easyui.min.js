...
if(_59.pageIndex>1){
_60(_58,_59.pageIndex-1);
}
});
_5a.find("a[icon=pagination-next]").unbind(".pagination").bind("click.pagination",function(){
var _5c=Math.ceil(_59.rowCount/_59.pageSize);
if(_59.pageIndex<_5c){
_60(_58,_59.pageIndex+1);
}
});
_5a.find("a[icon=pagination-last]").unbind(".pagination").bind("click.pagination",function(){
var _5d=Math.ceil(_59.rowCount/_59.pageSize);
if(_59.pageIndex<_5d){
_60(_58,_5d);
}
});
_5a.find("a[icon=pagination-load]").unbind(".pagination").bind("click.pagination",function(){
if(_59.onBeforeRefresh.call(_58,_59.pageIndex,_59.pageSize)!=false){
_60(_58,_59.pageIndex);
_59.onRefresh.call(_58,_59.pageIndex,_59.pageSize);
}
});
...
var _5f=Math.ceil(_59.rowCount/_59.pageSize);
_60(_58,_59.pageIndex);
});
};
function _60(_61,_62){
var _63=$.data(_61,"pagination").options;
var _64=Math.ceil(_63.rowCount/_63.pageSize)||1;
var _65=_62;
if(_62<1){
_65=1;
}
...
var _69=Math.ceil(_68.rowCount/_68.pageSize)||1;
var num=$(_67).find("input.pagination-num");
num.val(_68.pageIndex);
num.parent().next().find("span").html(_68.afterPageText.replace(/{pages}/,_69));
var _6a=_68.displayMsg;
_6a=_6a.replace(/{from}/,_68.pageSize*(_68.pageIndex-1)+1);
_6a=_6a.replace(/{to}/,Math.min(_68.pageSize*(_68.pageIndex),_68.rowCount));
_6a=_6a.replace(/{rowCount}/,_68.rowCount);
$(_67).find(".pagination-info").html(_6a);
$("a[icon=pagination-first],a[icon=pagination-prev]",_67).linkbutton({disabled:(_68.pageIndex==1)});
$("a[icon=pagination-next],a[icon=pagination-last]",_67).linkbutton({disabled:(_68.pageIndex==_69)});
if(_68.loading){
...
$.fn.pagination.defaults={rowCount:1,pageSize:20,pageIndex:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_73,_74){
},onBeforeRefresh:function(_75,_76){
},onRefresh:function(_77,_78){
},onChangePageSize:function(_79){
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {rowCount} items"};
})(jQuery);
(function($){
function _7a(_7b){
var _7c=$(_7b);
...
var rows=$.data(_3cd,"datagrid").data.tabList;
...
_3f3.pagination({pageIndex:opts.pageIndex,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_3f4,_3f5){
opts.pageIndex=_3f4;
opts.pageSize=_3f5;
_4ae(_3ea);
}});
...
if(opts.onClickRow){
opts.onClickRow.call(_3fa,_3fe,data.tabList[_3fe]);
}
}).bind("dblclick.datagrid",function(){
var _3ff=$(this).attr("datagrid-row-index");
if(opts.onDblClickRow){
opts.onDblClickRow.call(_3fa,_3ff,data.tabList[_3ff]);
}
}).bind("contextmenu.datagrid",function(e){
var _400=$(this).attr("datagrid-row-index");
if(opts.onRowContextMenu){
opts.onRowContextMenu.call(_3fa,e,_400,data.tabList[_400]);
}
});
...
data.tabList.sort(function(r1,r2){
...
if(_443.length){
if(_443.pagination("options").rowCount!=data.rowCount){
_443.pagination({rowCount:data.rowCount});
}
}
_3cc(_43e);
_3f9(_43e);
...
var rows=$.data(_446,"datagrid").data.tabList;
...
if(opts.idField){
for(var _458=0;_458<data.tabList.length;_458++){
_456.removeById(opts.idField,data.tabList[_458][opts.idField]);
}
}
opts.onUnselectAll.call(_454,data.tabList);
};
...
if(_45a<0||_45a>=data.tabList.length){
return;
}
if(opts.singleSelect==true){
_408(_459);
...
opts.onSelect.call(_459,_45a,data.tabList[_45a]);
...
if(data.tabList[i][opts.idField]==_462){
_463=i;
break;
}
}
...
if(_465<0||_465>=data.tabList.length){
return;
}
...
var row=data.tabList[_497];
if(_498.indexOf(row)>=0){
_498.remove(row);
}else{
_499.push(row);
}
_49a.removeById(opts.idField,data.tabList[_497][opts.idField]);
...
var ok=true;
for(var i=0,len=data.tabList.length;i<len;i++){
if(_46d(_4a6,i)){
_46e(_4a6,i,false);
}else{
ok=false;
...
data.rowCount+=_4ab.length-_4aa.length;
data.tabList=_4a9;
_43d(_4a8,data);
...
if(opts.pagination){
$.extend(_4b2,{pageIndex:opts.pageIndex,pageSize:opts.pageSize});
}
if(opts.sortName){
...
var rows=$.data(_4b5,"datagrid").data.tabList;
...
$.data(this,"datagrid",{options:opts,panel:_4bc.panel,selectedRows:[],data:{rowCount:0,tabList:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_3e9(this);
if(!_4bb){
var data=_3e5(this);
...
$.extend(opts,{pageIndex:_509.pageIndex,pageSize:_509.pageSize});
}
return opts;
...
return $.data(jq[0],"datagrid").data.tabList;
...
var rows=$.data(_52a,"datagrid").data.tabList;
...
var _53b=_539+1;
if(opts.pagination){
_53b+=(opts.pageIndex-1)*opts.pageSize;
}
...
_548=data.tabList.length;
}
if(_548>data.tabList.length){
_548=data.tabList.length;
}
for(var i=data.tabList.length-1;i>=_548;i--){
...
data.rowCount+=1;
data.tabList.splice(_548,0,row);
...
for(var i=_550+1;i<data.tabList.length;i++){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:null,columns:null,fitColumns:false,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,pagination:false,pageIndex:1,pageSize:20,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_556,_557){
},loadFilter:function(data){
if(typeof data.length=="number"&&typeof data.splice=="function"){
return {rowCount:data.length,tabList:data};
}else{
return data;
}
...
return $.data(_55a,"datagrid").data.tabList[_55b];
...
var rows=$.data(_583,"datagrid").data.tabList;
...
if(!_585){
_587.push("<span>");
_587.push(opts.groupFormatter.call(_583,_58a.fvalue,_58a.tabList));
_587.push("</span>");
}
_587.push("</td>");
_587.push("</tr>");
...
for(var j=0;j<_58a.tabList.length;j++){
var cls=(_588%2&&opts.striped)?"class=\"datagrid-row-alt\"":"";
var _58b=opts.rowStyler?opts.rowStyler.call(_583,_588,_58a.tabList[j]):"";
var _58c=_58b?"style=\""+_58b+"\"":"";
_587.push("<tr datagrid-row-index=\""+_588+"\" "+cls+" "+_58c+">");
_587.push(this.renderRow.call(this,_583,_586,_585,_588,_58a.tabList[j]));
_587.push("</tr>");
_588++;
}
_587.push("</tbody></table>");
...
for(var i=0;i<_594.length;i++){
var _595=_594[i];
for(var j=0;j<_595.tabList.length;j++){
_599.push(_595.tabList[j]);
}
}
$.data(_593,"datagrid").data.tabList=_599;
}});
...
_5a4.pagination({pageIndex:opts.pageIndex,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_5a5,_5a6){
opts.pageIndex=_5a5;
opts.pageSize=_5a6;
_5a7(_59c);
}});
...
if(opts.pagination){
$.extend(_5da,{page:opts.pageIndex,rows:opts.pageSize});
}
if(opts.sortName){
