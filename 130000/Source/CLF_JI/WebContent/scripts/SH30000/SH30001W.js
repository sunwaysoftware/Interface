...
function BindData(){
	...
	var url = "../sjsh/FINDSH30001.action";
	...
	$.ajax({
		   ...
		   success: function(msg){
             ...
             $.each(data, function(i, n){
            	 ...
            	 if(n.isInfo)
            		 tmprow.find("#msg").html("<a href='javascript:showWin(\""+n.fcid+"\");'><img title=\"未通过\" alt='未通过' src='../images/ico/11.gif'/></a>");
            	 else
            		 tmprow.find("#msg").html("<img title=\"待审核\" alt='待审核' src='../images/ico/0.gif'/>");
