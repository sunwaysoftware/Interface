...
<form action="../xtwh/KBSLKIMPORT.action" method="post" id="editForm" enctype="multipart/form-data">
	...
	<div>
		...
		<a href="javascript:void(0)" id="uploadBtn"><img src="../images/ico/upload.png" width="16" height="16" title="数据导入" alt="数据导入" />数据导入</a>
		<a href="../xtwh/VIEWT00357.action"><img src="../images/ico/Cancel.gif" width="16" height="16" title="<s:property value="getText('app.button.back')"/>" alt="<s:property value="getText('app.button.back')"/>" /><s:property value="getText('app.button.back')"/></a>
	</div>
	</div>
</div>
</div>
