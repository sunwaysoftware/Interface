...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
  <tr>
	...
	<div style="min-height:400px">
		<form action="../xtwh/PGFQIMPORT.action" method="post" id="editForm" enctype="multipart/form-data">
	...
	<div>
		...
		<a href="../xtwh/VIEWT00352.action"><img src="../images/ico/Cancel.gif" width="16" height="16" title="<s:property value="getText('app.button.back')"/>" alt="<s:property value="getText('app.button.back')"/>" /><s:property value="getText('app.button.back')"/></a>
	</div>
	</div>
</div>
</div>
