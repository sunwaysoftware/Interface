		...
		<s:else>
			<ul>
				<li>
                    ...
                    <a href="javascript:void(0)" title="<s:property value="note"/>" class="expanded" expXQID="<s:property value="xqdm"/>"><SPAN<s:if test="%{xqnm=='新建小区'}"> style="color:red;"</s:if>><s:property value="xqnm" /></SPAN></a>
				</li>
			</ul>
		</s:else>
	</s:iterator>