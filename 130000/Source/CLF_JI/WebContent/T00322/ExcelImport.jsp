...
<form action="../xtwh/GPIMPORT.action" method="post" id="editForm" enctype="multipart/form-data">
	...
	<span id="imgUpload" style="display:none"><img src="../scripts/easyui/themes/default/images/pagination_loading.gif"/>正在上传数据...</span>
		...
		<a href="../xtwh/VIEWT00322.action"><img src="../images/ico/Cancel.gif" width="16" height="16" title="<s:property value="getText('app.button.back')"/>" alt="<s:property value="getText('app.button.back')"/>" /><s:property value="getText('app.button.back')"/></a>
	</div>
	</div>
</div>
</div>
