...
$(function() {
	...
	$('#test').datagrid({
		...
		columns:[[	 
            {title:'<s:property value="%{getText('app.sjsh.t12084.shyy')}" />',field:'shyy',width:150},
...
<fieldset>
	<legend>【未过原因】<s:property value="%{getText('app.sjcj.t00302.fcid')}" />：<span id="fcid"><s:property value="txtSWIDFind" /></span></legend>
