...
<script type="text/javascript" src="../scripts/T00321/VIEWT00321.js"></script>
...
<!--							return "<a href=\"javascript:showpParentWin('[一手房交易数据编辑]','xtwh/ADDT00321.action?ACT=U&LC=" + rec.lc +"&ZCS=" + rec.zcs+"&SZQY=" + rec.cd00001Szqy + "&txtFWLX=" + rec.cd00001Fwlx + "','frameLCXSBG'); \"><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a><a href=\"javascript:DelData('" + rec.lc + ";" + rec.zcs + ";" +rec.cd00001Szqy +";" + rec.cd00002Pssd + ";" + rec.cd00001Fwlx +"')\"><img src=\"../images/ico/Delete.gif\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!--						}}-->
			]],
			columns:[[	   
				...
				{title:'<s:property value="%{getText('app.xtwh.t00303.zcdzl')}" />',field:'zcdzl',width:180},
				{title:'<s:property value="%{getText('app.xtwh.t00321.zh')}" />',field:'zh',width:80,align:'right'},
				{title:'<s:property value="%{getText('app.xtwh.t00321.dyh')}" />',field:'dyh',width:80,align:'right'},
				{title:'<s:property value="%{getText('app.xtwh.t00321.fh')}" />',field:'fh',width:80,align:'right'},
				{title:'<s:property value="%{getText('app.xtwh.t00321.clh')}" />',field:'clh',width:80,align:'right'},
	            ...
	            {title:'<s:property value="%{getText('app.xtwh.t00321.jcnf')}" />',field:'jcnf',width:80,align:'right'},
	            ...
	            {title:'<s:property value="%{getText('app.xtwh.t00321.pgjg')}" />',field:'pgjg',align:'right',width:100,formatter:function(value,rec){
					return '￥' + formatNumber(value,'#,##0.00');
				}},
				...
				{title:'<s:property value="%{getText('app.xtwh.t00321.jysj')}" />',field:'jysj',width:80,formatter:function(value,rec){
  ...
  <tr>
   ...
   <div class="ui-widget-content">
		<div class="datagrid-title">
			<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.t00321.title')}" /></span>
		</div>
		
		<div id="w" style="width:350px;height:200px;padding:5px;background: #fafafa;">
		<div id="sxkz" style="display:none;">
		<form id="findForm" action="../xtwh/EXPV00321.action" method="post" target="_blank">
		...
		<div>
		 ...
		 <tr>
		     <td>
<!--			<s:url id="urlAdd" action="ADDT00321"><s:param name="ACT">C</s:param></s:url>
			<s:a href="%{urlAdd}">
			...
			<a href="javascript:;" title="选择删除" id="selDel"><img src="../images/ico/Delete.gif" title="删除" alt="删除" width="16" height="16" align="absmiddle" />选择删除</a>
			 ...
			 <td>
			     <form action="../xtwh/YSFUPLOAD.action" method="post" id="uploadForm" enctype="multipart/form-data">
	     ...
	     <tr>
				<td></td>
				<td ><span style="color:red">*注：导入数据前，请确定数据格式及内容正确！</span><a href="../Date/import_ysf.xls">模板下载</a></td>
				</tr>
	     </table>
		</div>
