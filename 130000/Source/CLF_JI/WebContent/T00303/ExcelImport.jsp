...
<form action="../sjcj/LFPCIMPORT.action" method="post" id="editForm" enctype="multipart/form-data">
	...
	<div>
		...
		<a href="../xtwh/VIEWT00303.action"><img src="../images/ico/Cancel.gif" width="16" height="16" title="<s:property value="getText('app.button.back')"/>" alt="<s:property value="getText('app.button.back')"/>" /><s:property value="getText('app.button.back')"/></a>
	</div>
	</div>
</div>
</div>
