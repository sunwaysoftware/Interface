...
<script type="text/javascript" src="../scripts/T00361/VIEWT00361.js"></script>
	...
	$('#test').datagrid({					
		...
		frozenColumns:[[
					...
					{title:'操作',field:'edit',width:40,align:'center',formatter:function(value,rec){
						return "<a href=\"javascript:showpParentWin('[建筑成新修正编辑]','xtwh/ADDT00361.action?ACT=U&id=" + rec.id +"','frameLCXSBG'); \"><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a><a href=\"javascript:DelData('" + rec.id  + "')\"><img src=\"../images/ico/Delete.gif\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
					}}

					
<!--				  {title:'操作',field:'edit',width:35,align:'center',formatter:function(value,rec){-->
<!--					//return "<a href=ADDT00361.action?ACT=U&id=" + rec.id + "><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!--						return "<a href=\"javascript:showpParentWin('[分区建筑成新修正编辑]','xtwh/ADDT00361.action?ACT=U&id=" + rec.id + "','frameJZCXBG'); \"><img src=\"../images/ico/Edit.gif\" title=\"编辑\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!---->
<!--				  }},-->
<!--				  {title:'删除',field:'del',width:35,align:'center',formatter:function(value,rec){-->
<!--				    return "<a href=ADDT00361.action?ACT=D&id=" + rec.id  + "><img src=\"../images/ico/Delete.gif\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!--				  }}-->
			]],
			columns:[[
		          ...
		          {title:'<s:property value="%{getText('app.xtwh.t00361.synx_min')}"/>',field:'synx_min',align:'right',width:100,formatter:function(value,rec){
						return formatNumber(value,'#,##0.00');
					}},
		          {title:'<s:property value="%{getText('app.xtwh.t00361.synx_max')}"/>',field:'synx_max',align:'right',width:100,formatter:function(value,rec){
						return formatNumber(value,'#,##0.00');
					}},
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				...
				<form id="findForm" action="EXPT00361.action" method="post" target="_blank">	
		...
		<div class="divbottom">
			<div>
				<table cellpadding="0" cellspacing="0" class="tablebottom">
					<tr>
						<td>
			                <s:url id="urlAdd" action="ADDT00361"><s:param name="ACT">C</s:param></s:url>
			                <s:a href="%{urlAdd}">
					     ...
					     <td>
			                 <form action="../xtwh/JCSJUPLOAD.action" method="post" id="uploadForm" enctype="multipart/form-data">
					...
					<tr>
						...
						<td></td>
				        <td ><span style="color:red">*注：导入数据前，请确定数据格式及内容正确！</span><a href="../Date/import_jcsj.xls" target="_blank">模板下载</a></td>
				        </tr>
				</table>
			</div>
		</div>
