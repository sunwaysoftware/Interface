...
<script type="text/javascript" src="../scripts/T00364A/VIEWT00364A.js"></script>
		...
		$('#test').datagrid({					
			...
			frozenColumns:[[
				{title:'操作',field:'edit',width:70,align:'center',formatter:function(value,rec){
					return "<a href=\"javascript:showpParentWin('[分区估价值数据编辑]','xtwh/ADDT00364A.action?ACT=U&XQDM=" + strIsEmpty(rec.cd00352Xqdm) +"&ddlSZQY=" + rec.cd00001Szqy + "','framePGZBG'); \"><img src=\"../images/ico/Edit.gif\" title=\"编辑\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>&nbsp;<a href=ADDT00364A.action?ACT=D&&XQDM=" + strIsEmpty(rec.cd00352Xqdm) +"&ddlSZQY=" + rec.cd00001Szqy + "><img src=\"../images/ico/Delete.gif\" title=\"删除\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
  <tr>
   ...
   <div class="ui-widget-content">
		...
		<div class="divbottom">
		<div>
			<s:url id="urlAdd" action="ADDT00364A"><s:param name="ACT">C</s:param></s:url>
			<s:a href="%{urlAdd}">
