...
<script type="text/javascript" src="../scripts/T00362/VIEWT00362.js"></script>
	...
	$('#test').datagrid({					
		...
		frozenColumns:[[
			...
			{title:'操作',field:'edit',width:40,align:'center',formatter:function(value,rec){
				return "<a href=\"javascript:showpParentWin('[建筑结构修正编辑]','xtwh/ADDT00362.action?ACT=U&id=" + rec.id +"','frameLCXSBG'); \"><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a><a href=\"javascript:DelData('" + rec.id  + "')\"><img src=\"../images/ico/Delete.gif\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
			}}
<!--			{title:'操作',field:'edit',width:35,align:'center',formatter:function(value,rec){-->
<!--				//	return "<a href=ADDT00362.action?ACT=U&id=" + rec.id + "><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!--				return "<a href=\"javascript:showpParentWin('[分区建筑结构修正编辑]','xtwh/ADDT00362.action?ACT=U&id=" + rec.id + "','frameJZJGBG'); \"><img src=\"../images/ico/Edit.gif\" title=\"编辑\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!---->
<!--			}},-->
<!--			{title:'删除',field:'del',width:35,align:'center',formatter:function(value,rec){-->
<!--				return "<a href=ADDT00362.action?ACT=D&id=" + rec.id  + "><img src=\"../images/ico/Delete.gif\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";-->
<!--		      }}-->
		]],
		columns:[[	 
		          ...
		          {title:'<s:property value="%{getText('app.xtwh.t00362.jzjg')}" />',field:'jzjg',width:100},
		          {title:'<s:property value="%{getText('app.xtwh.sywh.xzxs')}"/>(%)',field:'xzxs',align:'right',width:80,formatter:function(value,rec){
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				...
				<form id="findForm" action="EXPT00362.action" method="post" target="_blank">
				...
				<table width="300" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>&nbsp;<s:property value="%{getText('app.xtwh.t00362.jzjg')}" /></td>
                        <td>&nbsp;<span class="txtInfonm"><input name="txtJZJGNm" id="txtJZJGNm" type="text" value="<s:property value="txtJZJGNm" />" /><span id="spJZJG"></span></span><input type="hidden" id="txtJZJGFind" name="txtJZJGFind" value="<s:property value="txtJZJGFind" />" /></td>
                    </tr>
                     <tr>
                        <td>&nbsp;<s:property value="%{getText('app.xtwh.info.fwlx')}" /></td>
                        <td>&nbsp;<span class="txtInfonm"><input name="txtFWLXNm" id="txtFWLXNm" type="text" value="<s:property value="txtFWLXNm" />" /><span id="spFWLX"></span></span><input type="hidden" id="txtFWLXFind" name="txtFWLXFind" value="<s:property value="txtFWLXFind" />"/></td>
                    </tr>
		...
		<div class="divbottom">
			<div>
				<table cellpadding="0" cellspacing="0" class="tablebottom">
					<tr>
						<td>
			                <s:url id="urlAdd" action="ADDT00362"><s:param name="ACT">C</s:param></s:url>
			                <s:a href="%{urlAdd}">
					     ...
					     <td>
			                 <form action="../xtwh/JZJGUPLOAD.action" method="post" id="uploadForm" enctype="multipart/form-data">
					...
					<tr>
						...
						<td></td>
				        <td ><span style="color:red">*注：导入数据前，请确定数据格式及内容正确！</span><a href="../Date/import_jzjg.xls" target="_blank">模板下载</a></td>
				        </tr>
				</table>
			</div>
		</div>
