...
<script type="text/javascript" src="../scripts/T00323/VIEWT00323.js"></script>
...
<!--						}}-->
			...
			columns:[[	   
	            ...
	            {title:'<s:property value="%{getText('app.xtwh.t00323.jcnf')}" />',field:'jcnf',width:80,align:'right'},
				...
				{title:'<s:property value="%{getText('app.xtwh.t00323.fwcx')}" />',field:'fwcx',width:120},
				{title:'<s:property value="%{getText('app.xtwh.t00323.fwzx')}" />',field:'fwzx',width:120},
	            {title:'<s:property value="%{getText('app.xtwh.t00323.pgjg')}" />',field:'pgjg',align:'right',width:100,formatter:function(value,rec){
					return '￥' + formatNumber(value,'#,##0.00');
				}},
				...
				{title:'<s:property value="%{getText('app.xtwh.t00323.jysj')}" />',field:'jysj',width:80,formatter:function(value,rec){
  ...
  <tr>
   ...
   <div class="ui-widget-content">
		<div class="datagrid-title">
			<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.t00323.title')}" /></span>
		</div>
		
		<div id="w" style="width:350px;height:200px;padding:5px;background: #fafafa;">
		<div id="sxkz" style="display:none;">
		<form id="findForm" action="../xtwh/EXPV00323.action" method="post" target="_blank">
...
<!--			<s:url id="urlAdd" action="ADDT00322"><s:param name="ACT">C</s:param></s:url>
			...
			<a href="javascript:;" title="选择删除" id="selDel"><img src="../images/ico/Delete.gif" title="删除" alt="删除" width="16" height="16" align="absmiddle" />选择删除</a>
			 ...
			 <td>
			     <form action="../xtwh/ZJUPLOAD.action" method="post" id="uploadForm" enctype="multipart/form-data">
	     ...
	     <tr>
				<td></td>
				<td ><span style="color:red">*注：导入数据前，请确定数据格式及内容正确！</span><a href="../Date/import_zj.xls">模板下载</a></td>
		</tr>
	     </table>
		</div>
