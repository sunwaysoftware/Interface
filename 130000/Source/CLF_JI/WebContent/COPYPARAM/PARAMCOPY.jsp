...
<script type="text/javascript" src="../scripts/COPYPARAM/PARAMCOPY.js"></script>
	...
	<table width="100%" border="0" cellspacing="3" cellpadding="0">
			<tr>
				<td width="200">
					...
					<sw:szqy items="szqyList" name="ddlSZQY" id="ddlSZQY"  classid="txtfocus" />
				</td>
				<td align="left">
				</td>
			</tr>
			...
			<tr>
				<td>
					...
					<input type="text" style="width: 70px" name="txtPSSD" id="txtPSSD" onfocus="WdatePicker({dateFmt:'yyyy'})" class="Wdatefocus txtDateTime" />
				</td>
				<td align="left">
				请输入要复制到的估计时点
				</td>
