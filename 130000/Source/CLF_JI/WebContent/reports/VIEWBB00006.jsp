...
<script type="text/javascript" src="../scripts/reports/VIEWBB00006.js"></script>
  ...
  <tr>
	...
	<div class="datagrid-title">
		<span class="datagrid-title-text">
				<s:property value="%{getText('app.cxtj.bb00006.title')}" />
	     </span>
	</div>    
		...
		<td>
			<div style="background:#efefef;">				
				...
				<div id="sxkz" style="display:none;">
					<form id="findForm" action="EXPBB00006.action" method="post">
