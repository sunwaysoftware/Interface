...
<script type="text/javascript" src="../scripts/reports/VIEWBB00005.js"></script>
	...
	<div class="ui-widget-content">
		<div class="datagrid-title">
			<span class="datagrid-title-text"> <s:property
					value="%{getText('app.cxtj.bb00005.title')}" /> </span>
		</div>
		...
		<div id="bb"
			...
			<div id="sxkz" style="display: none;">
				<form id="findForm" action="FINDBB00005.action" method="post">
					<input type="hidden" name="hidSelect" id="hidSelect" />
					<table width="350" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td><s:property value="getText('app.xtwh.info.ssgx')" />
							</td>
							<td><span class="txtInfonm"><input type="text"
									id="txtSSGXTIP" name="txtSSGXTIP" /><span id="spSSGX"></span>
							</span> <input type="hidden" id="txtSSGX" name="txtSSGX"
								value="<s:property value="txtSSGX"/>" /></td>
						</tr>
						<tr>
							<td><s:property value="getText('app.sjcj.t00302.jysj')" />
							</td>
							<td><input type="text" id="txtJYSJMinFind"
								name="txtJYSJMinFind"
								value="<s:property value="txtJYSJMinFind"/>"
								onfocus="WdatePicker()" class="Wdatefocus" />-<input type="text"
								id="txtJYSJMaxFind" name="txtJYSJMaxFind"
								value="<s:property value="txtJYSJMaxFind"/>"
