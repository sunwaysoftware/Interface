...
<script type="text/javascript" src="../scripts/reports/VIEWBB00002.js"></script>
  ...
  <tr>
	...
	<div class="datagrid-title">
		<span class="datagrid-title-text">
				<s:property value="%{getText('app.cxtj.bb00002.title')}" />
	     </span>
	</div>
			<div id="bb" style="width:350px;height:350px;padding:5px;background: #fafafa;">
