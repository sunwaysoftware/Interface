...
<script type="text/javascript" src="../scripts/T00355/VIEWT00355.js"></script>
	...
	$(function() {
		...
		$('#test').datagrid({					
			...
			queryParams : 
		    {
				...
				txtLCFind: $("#txtLCFind").val(), 
				txtZCSFind: $("#txtZCSFind").val(),
				txtFWLX:$("#txtFWLX").val()
			},
			frozenColumns:[[
				{title:'<input type="checkbox" name="chkSelAll" id="chkSelAll" class="rootCheck radio" value="true"/>',field:'checkbox',width:30,align:'center',formatter:function(value,rec){
					return "<input type='checkbox' name='chkSel' id='chkSel' value='"+rec.lc + ";" + rec.zcs + ";" +rec.cd00001Szqy +";" + rec.cd00002Pssd + ";" + rec.cd00001Fwlx +"' class='childCheck radio'/>";
				}},
				{title:'操作',field:'edit',width:40,align:'center',formatter:function(value,rec){
							return "<a href=\"javascript:showpParentWin('[楼层系数数据编辑]','xtwh/ADDT00355.action?ACT=U&LC=" + rec.lc +"&ZCS=" + rec.zcs+"&SZQY=" + rec.cd00001Szqy + "&txtFWLX=" + rec.cd00001Fwlx + "','frameLCXSBG'); \"><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a><a href=\"javascript:DelData('" + rec.lc + ";" + rec.zcs + ";" +rec.cd00001Szqy +";" + rec.cd00002Pssd + ";" + rec.cd00001Fwlx +"')\"><img src=\"../images/ico/Delete.gif\" alt=\"删除\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
						}}
			]],
			columns:[[	      
	            ...
	            {title:'<s:property value="%{getText('app.xtwh.t00355.lc')}" />',field:'lc',width:80},
	            {title:'<s:property value="%{getText('app.xtwh.t00355.zlc')}" />',field:'zcs',width:80},
...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
  <tr>
   ...
   <div class="ui-widget-content">
		...
		<form id="findForm" action="../sjcx/EXPV00355.action" method="post" target="_blank">
			...
			<table width="300" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    <td>&nbsp;<s:property value="getText('app.xtwh.t00355.lc')"/></td>
			    <td>&nbsp;<input type="text" class="txtNumber" id="txtLCFind" name="txtLCFind" value="<s:property value="txtLCFind" />"/>	</td>
			  </tr>
			  <tr>
			    <td>&nbsp;<s:property value="getText('app.xtwh.t00355.zlc')"/></td>
			    <td>&nbsp;<input type="text" class="txtNumber" id="txtZCSFind" name="txtZCSFind" value="<s:property value="txtZCSFind" />"/></td>
			  </tr>
			  <tr>
	           	<td>&nbsp;<s:property value="%{getText('app.xtwh.info.fwlx')}" /></td>
	           	<td>&nbsp;<span class="txtInfonm"><input name="txtFWLXTIP" id="txtFWLXTIP" type="text" value="<s:property value="txtFWLXFind" />" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/><span id="spFWLX"></span></span><input type="hidden" id="txtFWLX" name="txtFWLX" />
	            </td>
	          </tr>
			</table>
			</form>
		...
		<div class="divbottom">
		 ...
		 <tr>
		     <td>
			<s:url id="urlAdd" action="ADDT00355"><s:param name="ACT">C</s:param></s:url>
			<s:a href="%{urlAdd}">
			...
			<a href="javascript:;" title="选择删除" id="selDel"><img src="../images/ico/Delete.gif" title="删除" alt="删除" width="16" height="16" align="absmiddle" />选择删除</a>
			 ...
			 <td>
			     <form action="../xtwh/LCXSUPLOAD.action" method="post" id="uploadForm" enctype="multipart/form-data">
	     ...
	     <tr>
				<td></td>
				<td ><span style="color:red">*注：导入数据前，请确定数据格式及内容正确！</span><a href="../Date/import_lcxs.xls">模板下载</a></td>
				</tr>
	     </table>
		</div>
	</div>
