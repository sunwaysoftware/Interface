 ...
 * @version 1.0
 */
public class PgvDb000013DAO extends BaseDAO implements IPgvDb000013DAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvDb000013DAO#LoadAll(com.sunway.vo.PgvDb000013)
	 */
	
	@Override
	public PgvDb000013 LoadAll(PgvDb000013 db000013) throws Exception {
		PgvDb000013 listResult = new PgvDb000013();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_DB_000013(?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			call.registerOutParameter(2, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(3, db000013.getCd00002Pssd());
			call.setString(4, db000013.getCd00001Ssgx());
			call.setString(5, db000013.getCd00002Czr());
			call.execute();
			//返回列合
			...
			while (null != rs && rs.next()) {
				listResult.getDb000013List().add(SetVParameters(rs));
			}
		} catch (Exception e) {
			throw e;
		} finally {
	 ...
	 * @throws Exception
	 */
	protected PgvDb000013 SetVParameters(ResultSet rs) throws Exception {
		PgvDb000013 e = new PgvDb000013();
