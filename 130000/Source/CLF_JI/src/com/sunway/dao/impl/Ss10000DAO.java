 ...
 *
 */
public class Ss10000DAO extends BaseDAO implements ISs10000DAO {
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISs10000DAO#GetSsAgainAllCommand(com.sunway.vo.Pgv00041)
	 */
	...
	public Boolean GetSsAgainAllCommand(Pgv00041 bean) throws Exception {
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_CZ_000414(?,?,?,?,?)}");
			//传入输入参数
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISs10000DAO#GetSsAgainCommand(com.sunway.vo.Pgv00041)
	 */
	...
	public Boolean GetSsAgainCommand(Pgv00041 bean) throws Exception {
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_CZ_0004141(?,?,?,?)}");
			//传入输入参数
			call.setString(1, bean.getCd12301Swid());
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISs10000DAO#GetSsCommand(com.sunway.vo.Pgv12001)
	 */
	...
	public Boolean GetSsCommand(Pgv12001 bean) throws Exception {
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_CZ_000411(?,?,?,?)}");
			//传入输入参数
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISs10000DAO#LoadSsSwid(com.sunway.vo.Pgv12001)
	 */
	...
	public ArrayList<Pgv12001> LoadSsSwid(Pgv12001 bean) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT1003121(?,?,?,?,?)}");
			//注冊輸出參數
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.ISs10000DAO#LoadNotice(com.sunway.vo.Ss00000)
	 */
	...
	public Ss00000 LoadNotice(Ss00000 ss00000) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_CZ_00043(?,?,?,?,?,?,?,?)}");
			// 注册输出参数
			call.registerOutParameter(1, OracleTypes.CURSOR);
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.ISs10000DAO#printcz(com.sunway.vo.Ss00000)
	 */
	...
	public Boolean printcz(Ss00000 ss00000) throws Exception {
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_CZ_000431(?,?,?,?)}");
			//传入输入参数
