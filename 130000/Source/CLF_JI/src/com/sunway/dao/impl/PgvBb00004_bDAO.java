 ...
 * @version 1.0
 */
public class PgvBb00004_bDAO extends BaseDAO implements IPgvBb00004_bDAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvBb00004_bDAO#LoadAll(com.sunway.vo.PgvBb00004_b)
	 */
	
	@Override
	public ArrayList<PgvBb00004_b> LoadAll(PgvBb00004_b bb00004_b) throws Exception {
		ArrayList<PgvBb00004_b> listResult = new ArrayList<PgvBb00004_b>();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_BB_00004_B(?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(2, bb00004_b.getCd00001Ssgx());
			call.setString(3, bb00004_b.getCd00002Pssd());
			call.setBoolean(4, bb00004_b.getSfssgx());
			call.setString(5, bb00004_b.getCd00002Czr());
			call.execute();
			// 返回數據集
	 ...
	 * @throws Exception
	 */
	protected PgvBb00004_b SetVParameters(ResultSet rs) throws Exception {
		PgvBb00004_b e = new PgvBb00004_b();
