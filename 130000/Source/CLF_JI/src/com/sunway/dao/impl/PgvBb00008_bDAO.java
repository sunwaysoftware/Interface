 ...
 * @version 1.0
 */
public class PgvBb00008_bDAO extends BaseDAO implements IPgvBb00008_bDAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvBb00008_bDAO#LoadAll(com.sunway.vo.PgvBb00008_b)
	 */
	
	@Override
	public ArrayList<PgvBb00008_b> LoadAll(PgvBb00008_b bb00008_b) throws Exception {
		ArrayList<PgvBb00008_b> listResult = new ArrayList<PgvBb00008_b>();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_BB_00008_B(?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(2, bb00008_b.getCd00001Ssgx());
			call.setString(3, bb00008_b.getCd00002Pssd());
			call.setBoolean(4, bb00008_b.getSfssgx());
			call.setString(5, bb00008_b.getCd00002Czr());
			call.execute();
			// 返回數據集
	 ...
	 * @throws Exception
	 */
	protected PgvBb00008_b SetVParameters(ResultSet rs) throws Exception {
		PgvBb00008_b e = new PgvBb00008_b();
