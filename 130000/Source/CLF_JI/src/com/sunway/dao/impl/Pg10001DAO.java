 ...
 *
 */
public class Pg10001DAO extends BaseDAO implements IPg10001DAO {

	/* (non-Javadoc)
	 * @see com.sunway.dao.IPg10001DAO#GetExecPG(com.sunway.vo.Pgv12001)
	 */
	...
	public Boolean GetExecPG(Pgv12001 bean) throws Exception {
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_CZ_10031(?,?,?)}");
			//传入输入参数
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.IPg10001DAO#LoadPg(com.sunway.vo.Pgv12001)
	 */
	...
	public ArrayList<Pgv12001> LoadPg(Pgv12001 bean) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT100311(?,?,?,?,?,?,?)}");
			//注冊輸出參數
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.IPg10001DAO#LoadPgSwidList(com.sunway.vo.Pgv12001)
	 */
	...
	public ArrayList<Pgv12001> LoadPgSwidList(Pgv12001 bean) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT1003111(?,?,?,?,?)}");
			//注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			//傳入輸入參數
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.IPg10001DAO#LoadPgMxNgList(com.sunway.vo.Pgv12004)
	 */
