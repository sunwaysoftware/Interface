 ...
 *
 */
public class Sh10001DAO extends BaseDAO implements ISh10001DAO {
	
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISh10001DAO#LoadSh(com.sunway.vo.Pgv12001)
	 */
	...
	public ArrayList<Pgv12001> LoadSh(Pgv12001 bean) throws Exception {
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_GETALLT120011(?,?,?,?,?,?,?)}");
			//注冊輸出參數
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISh10001DAO#LoadShMxNgList(com.sunway.vo.Pgv12004)
	 */
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISh10001DAO#GetExecSH(com.sunway.vo.Pgv12001)
	 */
	...
	public Boolean GetExecSH(Pgv12001 bean) throws Exception {
		...
		try {
			...
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_CZ_10081(?,?,?,?)}");
			//传入输入参数
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISh10001DAO#LoadShSwidList(com.sunway.vo.Pgv12004)
	 */
	...
	public ArrayList<Pgv12001> LoadShSwidList(Pgv12001 bean) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT1200111(?,?,?,?,?)}");
			//注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			//傳入輸入參數
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.ISh10001DAO#GetExecForceSH(com.sunway.vo.Pgv12001)
	 */
	...
	public Boolean GetExecForceSH(Pgv12001 bean) throws Exception {
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_CZ_10082(?,?,?)}");
			//传入输入参数
			call.setString(1, bean.getSwid());
			call.setString(2, bean.getShCzr());
			call.setString(3, bean.getSysPssd());
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.ISh10001DAO#LoadSh1200112(com.sunway.vo.Pgv12001)
	 */
	...
	public ArrayList<Pgv12001> LoadSh1200112(Pgv12001 bean) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT1200112(?,?,?,?,?,?,?)}");
			//注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			//傳入輸入參數
			call.setInt(2, bean.getPageIndex());
