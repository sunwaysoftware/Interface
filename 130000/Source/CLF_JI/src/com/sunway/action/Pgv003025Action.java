...
public class Pgv003025Action extends ActionSupport implements SessionAware {
	...
	public String query() throws Exception {
		...
		try {
			...
			// 准备查询条件
			v00302.setFcid(Common.trim(txtFCIDFind));
			v00302.setCd00301Swid(Common.getSearchLike(txtSWIDFind));
			v00302.setNsrmc(Common.getSearchLike(txtNSRMCFind));
			v00302.setZcdzl(Common.getSearchLike(txtZCDZLFind));
			v00302.setCd00001Szqy(ddlSZQYFind);
			v00302.setXqnm(Common.getSearchLike(txtXQFind));
			
			v00302.setJzmj_min(Common.convertToDouble(txtJZMJMINFind));
			v00302.setJzmj_max(Common.convertToDouble(txtJZMJMAXFind));
			v00302.setJyjg_min(Common.convertToDouble(txtJYJGMINFind));
			v00302.setJyjg_max(Common.convertToDouble(txtJYJGMAXFind));
			v00302.setJysj_min(Common.convertStringToDate(txtJYSJMINFind));
			v00302.setJysj_max(Common.convertStringToDate(txtJYSJMAXFind));
...
//			v00302.setCd00001Ssgx(sessionCtrl.Get(SessionCtrl.SESSION_KEY_SSGX));
			...
			v00302.setSzlc(Common.convertToShort(txtSZLCFind));
			v00302.setDjrq(Common.convertStringToDate(txtDJRQFind));
			v00302.setCd00002Czr(txtCZRFind);
			v00302.setUpddateS(Common.convertStringToDate(txtUPDDATES));
			v00302.setUpddateE(Common.convertStringToDate(txtUPDDATEE));
	...
	public String query_B() throws Exception {
		...
		try {
			...
			v00302.setUpddateS(Common.convertStringToDate(txtUPDDATES));
			v00302.setUpddateE(Common.convertStringToDate(txtUPDDATEE));
			v00302.setUpddateSRD(Common.convertStringToDate(txtUPDDATRD));
			v00302.setUpddateERD(Common.convertStringToDate(txtUPDDATEERD));			
			v00302.setSysPssd(sessionCtrl.Get(SessionCtrl.SESSION_KEY_PSSD));
			v00302.setZcdzbm(txtZCDZBMFind);
			v00302.setLh(txtLHFind);
			v00302.setPageIndex(pageIndex);
