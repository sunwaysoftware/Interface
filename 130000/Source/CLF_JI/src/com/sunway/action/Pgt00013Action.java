...
public class Pgt00013Action extends ActionSupport implements SessionAware{
	...
	private ArrayList<Pgv00013> tabList;
	...
	public String query() throws Exception {
		...
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			//准备查询条件
			v00013.setLogtype(Common.convertToInteger(txtLOGTYPEFind));
			v00013.setTablename(Common.getSearchLike(txtTABLENAMEFind));
			v00013.setCd00002Czr(Common.getSearchLike(txtCZRFind));
			...
			//执行查询
			tabList = t00013Service.LoadAll(v00013);
			//分页设置
	...
	public void validateUpdate() throws Exception{
		...
		t00013Bean.setStartdate(Common.convertStringToTimestamp(txtSTARTDATE));
		t00013Bean.setEnddate(Common.convertStringToTimestamp(txtENDDATE));
		t00013Bean.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
		t00013Bean.setLogtype(Common.convertToInteger(txtLOGTYPE));
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgv00013> getTabList() {
		return tabList;
	}
	 ...
	 */
	public void setTabList(ArrayList<Pgv00013> tabList) {
