...
public class Pgt00053Action extends ActionSupport implements SessionAware {
	...
	public String query() throws Exception {
		...
		try {
			...
			// 准备查询条件
			v00053.setXzlx(Common.convertToShort(ddlXZLXFind));
			v00053.setQtxznm(txtQtxzmcFind);
			v00053.setQtxznm(Common.getSearchLike(Common.convertEncoding(txtQtxzmcFind)));
	...
	public String create() throws Exception {
		...
		try {
			if (!Constant.MOD_CREATE.equals(getACT())) {
				...
				t00053Bean.setXzlx(Common.convertToShort(ddlXZLX));
	...
	public void validateUpdate() throws Exception {
		...
		if ((Constant.MOD_UPDATE.equals(getACT()))
			...
			t00053Bean.setXzlx(Common.convertToShort(ddlXZLX));
			t00053Bean.setXzxs(Common.convertToDouble(txtXZXS));
	...
	private String getNavigator(String szqy, String xzlx, String qtxzID, String noqtxzID,String parentID) throws Exception {
		...
		try {
			...
			if(!Common.isNullOrEmpty(xzlx)){
				v00053.setXzlx(Common.convertToShort(xzlx));
			}
			if (!Common.isNullOrEmpty(qtxzID)) {
				v00053.setQtxzid(qtxzID);
			}
			if (!Common.isNullOrEmpty(noqtxzID)){
