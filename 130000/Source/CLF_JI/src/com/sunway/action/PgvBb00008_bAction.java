...
public class PgvBb00008_bAction extends ActionSupport implements SessionAware {

	private static final long serialVersionUID = 3549308172319458160L;
	// Service
	private IPgvBb00008_bService bb00008_bService;
	private IPgv12001_bService v12001_bService;
	// Bean数组
	private ArrayList<PgvBb00008_b> operList;
	...
	public String query() throws Exception {
		...
		PgvBb00008_b bb00008_b = new PgvBb00008_b();
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			// 准备查询条件
			bb00008_b.setCd00002Pssd(Common.convertEncoding(Common.trim(ddlPSSDFind)));
			bb00008_b.setCd00001Ssgx(Common.convertEncoding(Common.trim(ddlSSGXFind)));
			bb00008_b.setSfssgx(Common.checkNull(chkSFSSGX));
			bb00008_b.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
			operList = bb00008_bService.LoadAll(bb00008_b);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			this.addActionError(e.getMessage());
	...
	/**
	 * @return the bb00008_bService
	 */
	@JSON(deserialize = false, serialize = false)
	public IPgvBb00008_bService getBb00008_bService() {
		return bb00008_bService;
	}
	/**
	 * @param bb00008_bService the bb00008_bService to set
	 */
	public void setBb00008_bService(IPgvBb00008_bService bb00008_bService) {
		this.bb00008_bService = bb00008_bService;
	}
	/**
	 ...
	 * @return the operList
	 */
	public ArrayList<PgvBb00008_b> getOperList() {
		return operList;
	}
	/**
	 * @param operList the operList to set
	 */
	public void setOperList(ArrayList<PgvBb00008_b> operList) {
