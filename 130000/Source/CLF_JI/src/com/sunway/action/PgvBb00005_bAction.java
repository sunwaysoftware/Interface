...
public class PgvBb00005_bAction extends ActionSupport implements SessionAware {

	private static final long serialVersionUID = -3007391883783275047L;
	// Service
	private IPgvBb00005_bService bb00005_bService;
	private IPgv12001_bService v12001_bService;
	// Bean数组
	private ArrayList<PgvBb00005_b> operList;
	...
	public String query() throws Exception {
		...
		PgvBb00005_b bb00005_b = new PgvBb00005_b();
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			// 准备查询条件
			bb00005_b.setCd00002Pssd(Common.convertEncoding(Common.trim(ddlPSSDFind)));
			bb00005_b.setCd00001Ssgx(Common.convertEncoding(Common.trim(ddlSSGXFind)));
			bb00005_b.setSfssgx(Common.checkNull(chkSFSSGX));
			bb00005_b.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
			operList = bb00005_bService.LoadAll(bb00005_b);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			this.addActionError(e.getMessage());
	...
	/**
	 * @return the bb00005_bService
	 */
	@JSON(deserialize = false, serialize = false)
	public IPgvBb00005_bService getBb00005_bService() {
		return bb00005_bService;
	}
	/**
	 * @param bb00005_bService the bb00005_bService to set
	 */
	public void setBb00005_bService(IPgvBb00005_bService bb00005_bService) {
		this.bb00005_bService = bb00005_bService;
	}
	/**
	 ...
	 * @return the operList
	 */
	public ArrayList<PgvBb00005_b> getOperList() {
		return operList;
	}
	/**
	 * @param operList the operList to set
	 */
	public void setOperList(ArrayList<PgvBb00005_b> operList) {
