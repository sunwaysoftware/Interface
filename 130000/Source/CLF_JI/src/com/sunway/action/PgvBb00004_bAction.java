...
public class PgvBb00004_bAction extends ActionSupport implements SessionAware {

	private static final long serialVersionUID = -4586368411408626724L;
	// Service
	private IPgvBb00004_bService bb00004_bService;
	private IPgv12001_bService v12001_bService;
	// Bean数组
	private ArrayList<PgvBb00004_b> operList;
	...
	public String query() throws Exception {
		...
		PgvBb00004_b bb00004_b = new PgvBb00004_b();
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			// 准备查询条件
			bb00004_b.setCd00002Pssd(Common.convertEncoding(Common.trim(ddlPSSDFind)));
			bb00004_b.setCd00001Ssgx(Common.convertEncoding(Common.trim(ddlSSGXFind)));
			bb00004_b.setSfssgx(Common.checkNull(chkSFSSGX));
			bb00004_b.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
			operList = bb00004_bService.LoadAll(bb00004_b);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			this.addActionError(e.getMessage());
	...
	/**
	 * @return the bb00004_bService
	 */
	@JSON(deserialize = false, serialize = false)
	public IPgvBb00004_bService getBb00004_bService() {
		return bb00004_bService;
	}
	/**
	 * @param bb00004_bService the bb00004_bService to set
	 */
	public void setBb00004_bService(IPgvBb00004_bService bb00004_bService) {
		this.bb00004_bService = bb00004_bService;
	}
	/**
	 ...
	 * @return the operList
	 */
	public ArrayList<PgvBb00004_b> getOperList() {
		return operList;
	}
	/**
	 * @param operList the operList to set
	 */
	public void setOperList(ArrayList<PgvBb00004_b> operList) {
