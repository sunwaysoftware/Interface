...
public class PgvBb00002_bAction extends ActionSupport implements SessionAware {

	private static final long serialVersionUID = -3875493365672817132L;
	// Service
	private IPgvBb00002_bService bb00002_bService;
	private IPgv12001_bService v12001_bService;
	// Bean数组
	private ArrayList<PgvBb00002_b> operList;
	...
	public String query() throws Exception {
		...
		PgvBb00002_b bb00002_b = new PgvBb00002_b();
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			// 准备查询条件
			bb00002_b.setCd00002Pssd(Common.convertEncoding(Common.trim(ddlPSSDFind)));
			bb00002_b.setCd00001Ssgx(Common.convertEncoding(Common.trim(ddlSSGXFind)));
			bb00002_b.setSfssgx(Common.checkNull(chkSFSSGX));
			bb00002_b.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
			operList = bb00002_bService.LoadAll(bb00002_b);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			this.addActionError(e.getMessage());
	...
	/**
	 * @return the bb00002_bService
	 */
	@JSON(deserialize = false, serialize = false)
	public IPgvBb00002_bService getBb00002_bService() {
		return bb00002_bService;
	}
	/**
	 * @param bb00002_bService the bb00002_bService to set
	 */
	public void setBb00002_bService(IPgvBb00002_bService bb00002_bService) {
		this.bb00002_bService = bb00002_bService;
	}
	/**
	 ...
	 * @return the operList
	 */
	public ArrayList<PgvBb00002_b> getOperList() {
		return operList;
	}
	/**
	 * @param operList the operList to set
	 */
	public void setOperList(ArrayList<PgvBb00002_b> operList) {
