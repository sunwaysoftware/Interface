...
public class Pgt00321Action extends ActionSupport implements SessionAware{
	...
	//Bean数组
	private ArrayList<Pgv00321> tabList;
	...
	public String query() throws Exception {
		...
		try { 
			...
			//执行查询
			tabList = t00321Service.LoadAll(v00321);
	...
	public String createByAjax() throws Exception{
		...
		try {
			if(!Constant.MOD_CREATE.equals(getACT())){
				//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
				//取得用户选中的数据信息
				t00321.setLc(Common.convertToShort(txtLC));
				t00321.setCd00001Fwlx(txtFWLX);
				//t00355.setYwdt(YWDT);
				t00321.setZcs(Common.convertToShort(txtZCS));
...
/*********************** set and get ******************************/
	...
	*/
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgv00321> getTabList() {
		return tabList;
	}
	 ...
	 */
	public void setTabList(ArrayList<Pgv00321> tabList) {
