...
public class Pgv00302_bAction extends ActionSupport implements SessionAware {
	...
	private ArrayList<Pgv00302_b> tabList;
	...
	public String query() throws Exception {
		...
		try {
			...
			v00302_b.setCd00001Ssgx(Common.trim(ddlSSGXFind));
			v00302_b.setCd00002Pssd(Common.trim(txtPSSDFind));
			v00302_b.setFcid(Common.trim(txtFCIDFind));
			v00302_b.setCd00301BSwid(Common.getSearchLike(txtSWIDFind));
			v00302_b.setNsrmc(Common.getSearchLike(txtNSRMCFind));
			v00302_b.setFdcdat(Common.getSearchLike(txtFDCDATFind));
			v00302_b.setCd00001Szqy(ddlSZQYFind);
			v00302_b.setXqnm(Common.getSearchLike(txtXQFind));
			v00302_b.setFwtdzl(Common.getSearchLike(txtFWTDZLFind));
			v00302_b.setSczt(ddlSCZTFind);
			// 执行查询
			v00302_bBean = v00302_bService.LoadAll(v00302_b);
			tabList = v00302_bBean.getV00302_bList();
			// 分页设置
	...
	public String detail() throws Exception {
		...
		try {
			// 准备查询条件
			v00302_b.setFcid(Common.convertEncoding(Common.trim(FCID)));
			v00302_b.setCd00002Pssd(Common.convertEncoding(Common.trim(PSSD)));
			// 执行查询
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgv00302_b> getTabList() {
		return tabList;
	}
	/**
	 * @param tabList the tabList to set
	 */
	public void setTabList(ArrayList<Pgv00302_b> tabList) {
