...
public class Bb00008Action extends ActionSupport{
	...
	private ArrayList<BF00008> tabList;
	//数据导出
	...
	public String query() throws Exception{
		...
		try{
			...
			tabList = bb00008Service.LoadAll(bean);
		}catch(Exception e){
			LOG.error(e.getMessage());
			if(LOG.isDebugEnabled()){
				LOG.debug("query() ********** end **********");
	...
	public ArrayList<BF00008> getTabList() {
		return tabList;
	}

	public void setTabList(ArrayList<BF00008> tabList) {
