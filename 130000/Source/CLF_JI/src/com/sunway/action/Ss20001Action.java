 ...
 *
 */
public class Ss20001Action extends ActionSupport implements SessionAware {
	private static final long serialVersionUID = -6093174850274530782L;
	...
	public String executeSS() throws Exception {
		...
		try {
			...
			case 1://選擇算稅
				...
				for(Integer i=0; i<chkSel.length; i++){
					try {
						...
						//執行算稅
						if(ss20000Service.GetSsCommand(v12001)){
							ssCount++;
						}	
					} catch (Exception e2) {
			...
			case 2://全部算稅
				...
				tabList = ss20000Service.LoadSsSwid(v12001);
