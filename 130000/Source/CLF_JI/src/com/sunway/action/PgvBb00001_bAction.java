...
public class PgvBb00001_bAction extends ActionSupport implements SessionAware  {

	private static final long serialVersionUID = -1158763939667865732L;
	// Service
	private IPgvBb00001_bService bb00001_bService;
	private IPgv12001_bService v12001_bService;
	// Bean数组
	
	private ArrayList<PgvBb00001_b> operList;
	...
	public String query() throws Exception {
		...
		PgvBb00001_b bb00001_b = new PgvBb00001_b();
		try {
			// 准备查询条件
			bb00001_b.setCd00002Pssd(Common.convertEncoding(Common.trim(ddlPSSDFind)));
			bb00001_b.setCd00001Ssgx(Common.convertEncoding(Common.trim(ddlSSGXFind)));
			bb00001_b.setSfssgx(Common.checkNull(chkSFSSGX));
			operList = bb00001_bService.LoadAll(bb00001_b);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			this.addActionError(e.getMessage());
	...
	/**
	 * @return the bb00001_bService
	 */
	@JSON(deserialize = false, serialize = false)
	public IPgvBb00001_bService getBb00001_bService() {
		return bb00001_bService;
	}
	/**
	 * @param bb00001_bService the bb00001_bService to set
	 */
	public void setBb00001_bService(IPgvBb00001_bService bb00001_bService) {
		this.bb00001_bService = bb00001_bService;
	}
	/**
	 ...
	 * @return the operList
	 */
	public ArrayList<PgvBb00001_b> getOperList() {
		return operList;
	}
	/**
	 * @param operList the operList to set
	 */
	public void setOperList(ArrayList<PgvBb00001_b> operList) {
