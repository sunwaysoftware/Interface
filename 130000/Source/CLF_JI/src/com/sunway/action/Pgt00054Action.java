...
public class Pgt00054Action extends ActionSupport implements SessionAware {
	...
	public void validateUpdate() throws Exception{
		...
		//判断PK是否重复
		if((Constant.MOD_CREATE.equals(getACT()))&&(!Common.isNullOrEmpty(t00054Bean.getUpddate()))){
			this.addActionError(getText("app.msg.error.pk", new String[]{getText("app.xtwh.t00054.bzbm")}));
		}
		//判读数据是否已经被其他用户修改
		if((Constant.MOD_UPDATE.equals(getACT()))&&(!t00054Bean.getUpddate().equals(Common.convertStringToTimestamp(txtUPDATE)))) {
			...
			t00054Bean.setJzqsMin(Common.convertToDouble(txtJZQSMIN));
			t00054Bean.setJzqsMax(Common.convertToDouble(txtJZQSMAX));
			t00054Bean.setLsxsMin(Common.convertToDouble(txtLSXSMIN));
			t00054Bean.setLsxsMax(Common.convertToDouble(txtLSXSMAX));
			t00054Bean.setJgxgcMin(Common.convertToDouble(txtJGXGCMIN));
			t00054Bean.setJgxgcMax(Common.convertToDouble(txtJGXGCMAX));
