...
public class Bb00005Action extends ActionSupport implements SessionAware {
	...
	public String execute() throws Exception {
		txtJYSJMinFind=Common.getNextMonthFirst();
		txtJYSJMaxFind=Common.getCurrentDate();
	...
	public String query() throws Exception {
		...
		try {
			...
			bean.setJysjMin(Common.convertToDate(txtJYSJMinFind));
			bean.setJysjMax(Common.convertToDate(txtJYSJMaxFind));
