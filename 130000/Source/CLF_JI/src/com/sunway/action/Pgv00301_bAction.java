...
public class Pgv00301_bAction extends ActionSupport implements SessionAware {
	...
	// Bean数组
	private ArrayList<Pgv00301_b> tabList;
	...
	public String query() throws Exception {
		...
		try {
			...
			v00301_b.setSwid(Common.getSearchLike(txtSWIDFind));
			v00301_b.setNsrmc(Common.getSearchLike(txtNSRMCFind));
			v00301_b.setCd00001Ssgx(Common.trim(ddlSSGXFind));
			v00301_b.setCd00002Pssd(Common.trim(txtPSSDFind));
			v00301_b.setSczt(ddlSCZTFind);
			// 执行查询
			v00301_bBean = v00301_bService.LoadAll(v00301_b);
			tabList = v00301_bBean.getV00301_bList();
			// 分页设置
	...
	public String detail() throws Exception {
		...
		try {
			// 准备查询条件
			v00301_b.setSwid(Common.convertEncoding(Common.trim(SWID)));
			v00301_b.setCd00002Pssd(Common.convertEncoding(Common.trim(PSSD)));
			// 执行查询
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgv00301_b> getTabList() {
		return tabList;
	}
	/**
	 * @param tabList the tabList to set
	 */
	public void setTabList(ArrayList<Pgv00301_b> tabList) {
