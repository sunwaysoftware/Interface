...
public class Pgt00334cAction extends ActionSupport {
	...
	private ArrayList<Pgt00334c> tabList;
	...
	public String execute() throws Exception {
		...
		try {
			t00334cBean.setCd00302Fcid(Common.convertEncoding(FCID));
			t00334cBean.setCdSlid(Common.convertEncoding(SLID));
			tabList = t00334cService.LoadAll(t00334cBean);
		} catch (Exception e) {
	...
	public String execute_B() throws Exception {
		...
		try {
			t00334cBean.setCd00302Fcid(Common.convertEncoding(FCID));
			t00334cBean.setCdSlid(Common.convertEncoding(SLID));
			tabList = t00334cService.LoadAll_B(t00334cBean);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			return INPUT;
		}
	 ...
	 */
	public void setTabList(ArrayList<Pgt00334c> tabList) {
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgt00334c> getTabList() {
		return tabList;
	}
