 ...
 *
 */
public class Sh10002Action extends ActionSupport implements SessionAware {
	private static final long serialVersionUID = 1045250757455893502L;
	private ISh10002Service sh10002Service;
	...
	public String query() throws Exception {
		...
		try {
			...
			//执行查询
			tabList = sh10002Service.LoadShOK(v12001);
			//分页设置
	...
	public String executeShAgain() throws Exception{
		...
		try {
			...
			case 1://選擇重新審核
				...
				//執行重新審核
				if(sh10002Service.GetExecShAgain(v12001))
			...
			case 2://全部重新審核
				...
				v12001.setNsrmc(Common.getSearchLike(Common.convertEncoding(txtNSRMCFind)));
				if(sh10002Service.GetExecShAgainAll(v12001))
	...
	/**
	 * @param sh10002Service the sh10002Service to set
	 */
	public void setSh10002Service(ISh10002Service sh10002Service) {
		this.sh10002Service = sh10002Service;
	}

	/**
	 * @return the sh10002Service
	 */
	@JSON(deserialize=false, serialize=false)
	public ISh10002Service getSh10002Service() {
		return sh10002Service;
	}
