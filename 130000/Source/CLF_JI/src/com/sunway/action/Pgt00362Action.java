...
public class Pgt00362Action extends ActionSupport implements SessionAware  {
	...
	private ArrayList<Pgv00362> tabList;
	...
	public String query()throws Exception{
		...
		try{
			...
			v00362.setCd_00002_pssd(Common.convertEncoding(Common.trim(txtPSSDFind)));
			v00362.setCd_00001_jzjg(Common.convertEncoding(Common.trim(txtJZJGFind)));
			v00362.setCd_00001_fwlx(Common.convertEncoding(Common.trim(txtFWLX)));
			v00362.setCd_00001_szqy(ddlSZQYFind);
            v00362.setSsgx(sessionCtrl.Get(SessionCtrl.SESSION_KEY_SSGX));
			tabList = t00362Service.LoadAll(v00362);
			//分页设置
	...
	public String create()throws Exception{
		...
		try{
			...
			if(!Constant.MOD_CREATE.equals(getACT())){
				...
				if(Common.isNullOrEmpty(t00362Bean.getUpddate())){
	...
	public void validateUpdate()throws Exception{
		...
		ReadInfo();
		t00362Bean.setId(txtLSH);
		t00362Bean.setCd_00002_pssd(sessionCtrl.Get(SessionCtrl.SESSION_KEY_PSSD));
		t00362Bean.setCd_00001_jzjg(Common.convertEncoding(Common.trim(txtJZJGT)));
		t00362Bean.setXzxs(Common.convertToDouble(txtXZXS));
		t00362Bean.setCzlx(Common.convertToInteger(txtCZLX));
		t00362Bean.setCd_00002_czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
		t00362Bean.setNote(txtNOTE);
		t00362Bean.setYwdt(0);
		t00362Bean.setCd_00001_fwlx(Common.convertEncoding(Common.trim(txtFWLX)));
		...
		//判断PK是否重复
		if((Constant.MOD_CREATE.equals(getACT())) && (!Common.isNullOrEmpty(t00362Bean.getUpddate()))){
		...
		//判断数据是否已经被他人修改
		if((Constant.MOD_UPDATE.equals(getACT())) && (!t00362Bean.getUpddate().equals(Common.convertStringToTimestamp(txtUPDATE)))) {
	...
	public String exportT00362()throws Exception{
		...
		try{
			...
			v00362.setCd_00002_pssd(Common.convertEncoding(Common.trim(txtPSSDFind)));
			v00362.setCd_00001_jzjg(Common.convertEncoding(Common.trim(txtJZJGFind)));
			v00362.setCd_00001_fwlx(Common.convertEncoding(Common.trim(txtFWLXFind)));
			v00362.setCd_00001_szqy(ddlSZQYFind);
            v00362.setSsgx(sessionCtrl.Get(SessionCtrl.SESSION_KEY_SSGX));
...
/*********************** set and get ******************************/
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgv00362> getTabList() {
		return tabList;
	}
	 ...
	 */
	public void setTabList(ArrayList<Pgv00362> tabList) {
