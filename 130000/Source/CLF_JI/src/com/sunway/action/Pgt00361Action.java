...
public class Pgt00361Action extends ActionSupport implements SessionAware  {
	...
	private ArrayList<Pgv00361> tabList;
	...
	public String query()throws Exception{
		...
		try{
			...
			v00361.setCd_00001_fwlx(Common.convertEncoding(Common.trim(txtFWLX)));
			...
			tabList = t00361Service.LoadAll(v00361);
	...
	public String create()throws Exception{
		...
		try{
			...
			if(!Constant.MOD_CREATE.equals(getACT())){
				...
				if(Common.isNullOrEmpty(t00361Bean.getUpddate())){
	...
	public String createByAjax()throws Exception{
		...
		try{
			if(!Constant.MOD_CREATE.equals(getACT())){
				...
				t00361.setSynx_min(Common.convertToInteger(txtSYNXMIN));
				t00361.setSynx_max(Common.convertToInteger(txtSYNXMAX));
				//t00361.setXzxs(Common.convertToDouble(txtXZXS));
	...
	public void validateUpdate()throws Exception{
		...
		ReadInfo();
		t00361Bean.setId(txtLSH);
		t00361Bean.setSynx_min(Common.convertToInteger(txtSYNXMIN));
		t00361Bean.setSynx_max(Common.convertToInteger(txtSYNXMAX));
		t00361Bean.setXzxs(Common.convertToDouble(txtXZXS));
		t00361Bean.setNote(txtNOTE);
		t00361Bean.setCd_00002_pssd(sessionCtrl.Get(SessionCtrl.SESSION_KEY_PSSD));
		t00361Bean.setCd_00001_fwlx(Common.convertEncoding(Common.trim(txtFWLX)));
		...
		//判断PK是否重复
		if((Constant.MOD_CREATE.equals(getACT())) && (!Common.isNullOrEmpty(t00361Bean.getUpddate()))){
		...
		//判断数据是否已经被其他人修改
		if((Constant.MOD_UPDATE.equals(getACT())) && (!t00361Bean.getUpddate().equals(Common.convertStringToTimestamp(txtUPDATE)))){
	...
	public String exportT00361() throws Exception{
		...
		try{
			...
			v00361.setCd_00001_fwlx(Common.convertEncoding(Common.trim(txtFWLXFind)));
...
/*********************** set and get ******************************/
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgv00361> getTabList() {
		return tabList;
	}
	 ...
	 */
	public void setTabList(ArrayList<Pgv00361> tabList) {
