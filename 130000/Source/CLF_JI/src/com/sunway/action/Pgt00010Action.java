...
//				(!Common.isNullOrEmpty(t00010Bean.getCd00003Roleid())))
//		  {
//			this.addActionError(getText("app.msg.error.pk", new String[]{getText("app.xtwh.t00003.roleid")}));
//		}
		//判读数据是否已经被其他用户修改
//		if((Constant.MOD_UPDATE.equals(getACT()))&&(!t00010Bean.getUpddate().equals(Common.convertStringToTimestamp(txtUPDATE)))) {
