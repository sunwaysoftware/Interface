...
public class Pgt00334aAction extends ActionSupport {
	...
	private ArrayList<Pgt00334a> tabList;
	...
	public String execute() throws Exception {
		...
		try {
			tabList = t00334aService.LoadAll(new Pgt00334a(txtFCID, txtSLID, txtPSSD));
		} catch (Exception e) {
			LOG.error("execute()", e);
	 ...
	 * @return the tabList
	 */
	public ArrayList<Pgt00334a> getTabList() {
		return tabList;
	}
	 ...
	 */
	public void setTabList(ArrayList<Pgt00334a> tabList) {
