...
public class ChartBzslkAction extends ActionSupport implements SessionAware {
	...
	private ArrayList<ChartBzslk> tabList;
	...
	public String execute() throws Exception {
		...
		try{
			...
			SysDate = Common.readCurrentYear();
		}catch(Exception e){
	...
	public String query() throws Exception {
		...
		try{
	        ...
	        chart.setCd00002Pssd(Common.trim(txtNF));
			...
			tabList = new ArrayList<ChartBzslk>();
			tabList.add(bSlk);
			tabList.add(sSlk);
			tabList.add(gSlk);
			tabList.add(ySlk);
	...
	public String update(){
		...
		try{
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			chart.setMonth(Common.convertStringToDate(txtMONTHFind));
			chart.setCzl(Common.convertToDouble(txtCZLUpd));
	...
	public String readZzl() throws Exception {
		...
		try{
			chart.setMonth(Common.convertStringToDate(txtMONTHFind));	
			chart.setGpqz(Common.convertToInteger(txtGPSJQZB));
			chart.setCd00352Xqdm(txtXQFind);
	        chart.setCd00001Szqy(ddlSZQYFind);
	 ...
	 */
	public void setTabList(ArrayList<ChartBzslk> tabList) {
	 ...
	 * @return the tabList
	 */
	public ArrayList<ChartBzslk> getTabList() {
		return tabList;
	}
