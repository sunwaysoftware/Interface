...
public class Pgt00351CsSameAction extends ActionSupport implements SessionAware {
	...
	public void validateCsBzf(){
		...
		v00351.setCd00001Jzjg(txtJZJG);
		v00351.setCd00001Jylx(txtJYLX);
		v00351.setGpqz(Common.convertToDouble(txtGPQZ));
		v00351.setGpxf(Common.convertToDouble(txtGPXF));
		v00351.setYwdt(Common.convertToInteger(rdoYWDT));
		v00351.setJysj(Common.convertToDate(txtPSSD+"-01"));
	...
	public String csBzf() throws Exception {
		...
		try {
			...
			case 1:// 選擇测算
				...
				break;
			case 2:// 全部测算
				tabList = t00351Service.LoadAllCsSameByBzfID(v00351);
