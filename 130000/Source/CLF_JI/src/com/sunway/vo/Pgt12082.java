...
public class Pgt12082 implements java.io.Serializable {

	private static final long serialVersionUID = 456608605258466295L;
	private String cd00001Tdytlx;
	...
	public Pgt12082(String cd00001Tdytlx, String cd00001Tdyt, Double minvalue,
			Double maxvalue, Timestamp upddate, String cd00002Czr, String note) {
		super();
		this.cd00001Tdytlx = cd00001Tdytlx;
	...
	/**
	 * @return the cd00001Tdytlx
	 */
	public String getCd00001Tdytlx() {
		return cd00001Tdytlx;
	}

	/**
	 * @param cd00001Tdytlx the cd00001Tdytlx to set
	 */
	public void setCd00001Tdytlx(String cd00001Tdytlx) {
		this.cd00001Tdytlx = cd00001Tdytlx;
	}
