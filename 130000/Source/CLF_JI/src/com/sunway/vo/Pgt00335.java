...
public class Pgt00335 implements java.io.Serializable {

	private static final long serialVersionUID = 2366970186055035092L;
	private String cd00302Fcid;
	private String cdSlid;
	private String cd00002Pssd;
	private Double pfmjg;
	private Short yxj;
	private Boolean zyxj;
	private Date jysj;
	private Double wjxz;
	private Double sllcxz;
	private Double slcxxz;
	private Double slcgxz;
	 ...
	 * @param cd00002Pssd
	 */
	public Pgt00335(String cd00302Fcid, String cd00002Pssd) {
	 ...
	 * @param cd00002Pssd
	 */
	public Pgt00335(String cd00302Fcid, String cdSlid, String cd00002Pssd) {
		this.cd00302Fcid = cd00302Fcid;
		this.cdSlid = cdSlid;
		this.cd00002Pssd = cd00002Pssd;
	}
	 ...
	 */
	public void setZyxj(Boolean zyxj) {
		this.zyxj = zyxj;
	}
	 ...
	 * @return the sllcxz
	 */
	public Double getSllcxz() {
		return sllcxz;
	}

	/**
	 * @param sllcxz the sllcxz to set
	 */
	public void setSllcxz(Double sllcxz) {
		this.sllcxz = sllcxz;
	}
	 ...
	 * @return the slcxxz
	 */
	public Double getSlcxxz() {
		return slcxxz;
	}

	/**
	 * @param slcxxz the slcxxz to set
	 */
	public void setSlcxxz(Double slcxxz) {
		this.slcxxz = slcxxz;
	}
	 ...
	 * @return the slcgxz
	 */
	public Double getSlcgxz() {
		return slcgxz;
	}

	/**
	 * @param slcgxz the slcgxz to set
	 */
	public void setSlcgxz(Double slcgxz) {
		this.slcgxz = slcgxz;
	}
