...
public class Pgt10056 implements java.io.Serializable {

	private static final long serialVersionUID = -824192171468004265L;
	private String cd00001Szqylx;
	private String cd00001Szqy;
	private String cd00002Pssd;
	private Double tdzs;
	private Double jztdzs;
	 ...
	 * @return the tdzs
	 */
	public Double getTdzs() {
		return tdzs;
	}

	/**
	 * @param tdzs the tdzs to set
	 */
	public void setTdzs(Double tdzs) {
		this.tdzs = tdzs;
	}
	 ...
	 * @return the jztdzs
	 */
	public Double getJztdzs() {
		return jztdzs;
	}

	/**
	 * @param jztdzs the jztdzs to set
	 */
	public void setJztdzs(Double jztdzs) {
		this.jztdzs = jztdzs;
	}
