...
/**
 * Pgv10031Id entity. @author MyEclipse Persistence Tools
 */


public class Pgv10031 implements java.io.Serializable {

	private static final long serialVersionUID = -8421439824533022011L;
	...
	public Pgv10031(String cd12001Swid, String cd00002Pssdy) {
	 ...
	 * full constructor
	 */
	public Pgv10031(String cd12004Mxid, Double fcpgjg, Double dcpgjg,
			Double pgjg, String cd00002Pssdy, Date cd00002Pssd, Double cxl,
	 ...
	 * @param sysSsgx
	 */
	public Pgv10031(String cd12001Swid, String nsrmc, Integer pageIndex,
			Integer pageSize, String sysPssd, String sysSsgx) {
		this.cd12001Swid = cd12001Swid;
		this.nsrmc = nsrmc;
		this.pageIndex = pageIndex;
		this.pageSize = pageSize;
	 ...
	 * @param recordIndex
	 */
	public Pgv10031(Double fcpgjg, Double dcpgjg, Double pgjg, Double gbfcpgjg,
