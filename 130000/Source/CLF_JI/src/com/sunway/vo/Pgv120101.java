...
/**
 * Pgv120101Id entity. @author MyEclipse Persistence Tools
 */


public class Pgv120101 implements java.io.Serializable {

	private static final long serialVersionUID = -3031997705773124883L;
	private String cjid;
	...
	/** minimal constructor */
	public Pgv120101(String cjid, String cd12003Fcid, String cd12002Dcid,
			...
			Boolean pglx, Date upddate, String cd00002Lrr) {
		this.cjid = cjid;
	...
	/** full constructor */
	public Pgv120101(String cjid, String cd12004Mxid, String cd12003Fcid,
			...
			String cd00002Pssd, Double pgjg, Boolean pglx, Date upddate,
			String cd00002Lrr, String note, String szqy, String tdyt,
			String tddj, String fwyt, String jzjg, String lrr) {
		this.cjid = cjid;
