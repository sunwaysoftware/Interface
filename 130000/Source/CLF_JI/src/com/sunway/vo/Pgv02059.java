...
public class Pgv02059 implements java.io.Serializable {

	private static final long serialVersionUID = -2520479465910475916L;
	private String cd00001Fwytlx;
	...
	/**
	 * @return the cd00001Fwytlx
	 */
	public String getCd00001Fwytlx() {
		return cd00001Fwytlx;
	}

	/**
	 * @param cd00001Fwytlx the cd00001Fwytlx to set
	 */
	public void setCd00001Fwytlx(String cd00001Fwytlx) {
		this.cd00001Fwytlx = cd00001Fwytlx;
	}
