...
public class Pgv00353 implements java.io.Serializable {

	private static final long serialVersionUID = -4772378201201116683L;
    ...
    private ArrayList<Pgv00353> outList;
    private String lxmc;
    private String cd00001Lxmc;
    private String cwxx;
	// Constructors
	...
	public ArrayList<Pgv00353> getOutList() {
		return outList;
	}

	public void setOutList(ArrayList<Pgv00353> outList) {
	...
	public String getCd00001Lxmc() {
		return cd00001Lxmc;
	}

	public void setCd00001Lxmc(String cd00001Lxmc) {
		this.cd00001Lxmc = cd00001Lxmc;
	}
