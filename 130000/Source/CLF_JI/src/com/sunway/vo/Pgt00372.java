 ...
 *
 */
public class Pgt00372 implements Serializable {

	private static final long serialVersionUID = -6619837790607073181L;
	private String fcid;				//房产编码
	private String fcslh;				//房产受理号
	...
	private Integer oinsid;				//房产主键
	private Double yjg;					//原价格
	private Double pgjg;				//非住宅的评估价格
	private String roomid;				//房产主键
