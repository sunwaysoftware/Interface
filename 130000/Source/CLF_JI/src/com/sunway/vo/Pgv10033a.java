...
/**
 * Pgv10033aId entity. @author MyEclipse Persistence Tools
 */


public class Pgv10033a implements java.io.Serializable {

	private static final long serialVersionUID = -3006634553830963766L;
	...
	/** minimal constructor */
	public Pgv10033a(String cd12004Mxid, String cd00002Pssd) {
		this.cd12004Mxid = cd12004Mxid;
		this.cd00002Pssd = cd00002Pssd;
	}

	/** full constructor */
	public Pgv10033a(String qtxzid, String cd12004Mxid, String cd00002Pssd,
			String qtxznm, Integer xzlx, Double xzxs, Date upddate,
			String cd00002Czr, String note, String czr, String xzmc) {
		this.qtxzid = qtxzid;
		this.cd12004Mxid = cd12004Mxid;
		this.cd00002Pssd = cd00002Pssd;
		this.qtxznm = qtxznm;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Pgv10033a))
			return false;
		Pgv10033a castOther = (Pgv10033a) other;
		...
		return ((this.getQtxzid() == castOther.getQtxzid()) || (this
				...
				&& ((this.getCzr() == castOther.getCzr()) || (this.getCzr() != null
						...
						castOther.getCzr())))
				&& ((this.getXzmc() == castOther.getXzmc()) || (this.getXzmc() != null
						&& castOther.getXzmc() != null && this.getXzmc()
						.equals(castOther.getXzmc())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getXzmc() == null ? 0 : this.getXzmc().hashCode());
		return result;
	}
