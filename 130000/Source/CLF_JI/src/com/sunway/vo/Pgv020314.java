...
/**
 * Pgv02031Id entity. @author MyEclipse Persistence Tools
 */


public class Pgv020314 implements java.io.Serializable {

	private static final long serialVersionUID = -8230052844693210754L;
	 ...
	 * @return the mjxz
	 */
	public Double getMjxz() {
		return mjxz;
	}

	/**
	 * @param mjxz the mjxz to set
	 */
	public void setMjxz(Double mjxz) {
		this.mjxz = mjxz;
	}
	 ...
	 * @return the xjbzxz
	 */
	public Double getXjbzxz() {
		return xjbzxz;
	}

	/**
	 * @param xjbzxz the xjbzxz to set
	 */
	public void setXjbzxz(Double xjbzxz) {
		this.xjbzxz = xjbzxz;
	}
	 ...
	 * @return the ssxz
	 */
	public Double getSsxz() {
		return ssxz;
	}

	/**
	 * @param ssxz the ssxz to set
	 */
	public void setSsxz(Double ssxz) {
		this.ssxz = ssxz;
	}
	 ...
	 * @return the zjbz
	 */
	public Double getZjbz() {
		return zjbz;
	}

	/**
	 * @param zjbz the zjbz to set
	 */
	public void setZjbz(Double zjbz) {
		this.zjbz = zjbz;
	}
	 ...
	 * @return the zbhl
	 */
	public Double getZbhl() {
		return zbhl;
	}

	/**
	 * @param zbhl the zbhl to set
	 */
	public void setZbhl(Double zbhl) {
		this.zbhl = zbhl;
	}
	...
	/**
	 * @param ytjzmj the ytjzmj to set
	 */
	 ...
	 */
	public void setQtxz(Double qtxz) {
		this.qtxz = qtxz;
	}
	...
	/**
	 * @param sypgczr the sypgczr to set
	 */
