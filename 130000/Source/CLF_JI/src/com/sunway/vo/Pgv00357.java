...
public class Pgv00357 implements java.io.Serializable {

	private static final long serialVersionUID = 5243236854963233662L;
	...
	private String fh;
	private String jcnf;
	private String zhxzs;
	private Integer csyf;
	private String jcsj;
	...
	/** default constructor */
	public Pgv00357() {
		outList = new ArrayList<Pgv00357>();
	}
	 ...
	 * @return the jgzk
	 */
	public String getJgzk() {
		return jgzk;
	}

	/**
	 * @param jgzk the jgzk to set
	 */
	public void setJgzk(String jgzk) {
		this.jgzk = jgzk;
	}
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00357> getOutList() {
		return outList;
	}
	 ...
	 */
	public void setOutList(ArrayList<Pgv00357> outList) {
	 ...
	 * @return the jgzkId
	 */
	public String getJgzkId() {
		return jgzkId;
	}

	/**
	 * @param jgzkId the jgzkId to set
	 */
	public void setJgzkId(String jgzkId) {
		this.jgzkId = jgzkId;
	}
	...
	public String getZhxzs() {
		return zhxzs;
	}

	public void setZhxzs(String zhxzs) {
		this.zhxzs = zhxzs;
	}
	...
	public Integer getCsyf() {
		return csyf;
	}

	public void setCsyf(Integer csyf) {
		this.csyf = csyf;
	}
