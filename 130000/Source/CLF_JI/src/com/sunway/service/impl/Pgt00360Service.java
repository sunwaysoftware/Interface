...
public class Pgt00360Service implements IPgt00360Service {
	private static Logger logger = LogManager.getLogger(Pgt00360Service.class.getName());
				...
				for(int i = 1;i < rowSheet;i++){
					...
					try{
						...
						try{
							...
							bean.setJzmjMin(BigDecimal.valueOf(Common.convertToDouble(value)));
						}catch(Exception e){
						...
						try{
							...
							bean.setJzmjMax(BigDecimal.valueOf(Common.convertToDouble(value)));
						}catch(Exception e){
						...
						try{
							...
							bean.setXzxs(BigDecimal.valueOf(Common.convertToDouble(value)));
						}catch(Exception e){
