...
public class Pgt00323Action extends ActionSupport implements SessionAware{
	...
	//Bean数组
	private ArrayList<Pgv00323> rows;
	...
	public String query() throws Exception {
		...
		try { 
			...
			//执行查询
			rows = t00323Service.LoadAll(v00323);
	...
	public String createByAjax() throws Exception{
		...
		try {
			if(!Constant.MOD_CREATE.equals(getACT())){
				//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
				//取得用户选中的数据信息
				t00323.setLc(ConvertUtil.toShort(txtLC));
				t00323.setCd00001Fwlx(txtFWLX);
				//t00355.setYwdt(YWDT);
				t00323.setZcs(ConvertUtil.toShort(txtZCS));
...
/*********************** set and get ******************************/
	...
	*/
	 ...
	 * @return the rows
	 */
	public ArrayList<Pgv00323> getRows() {
		return rows;
	}
	 ...
	 */
	public void setRows(ArrayList<Pgv00323> rows) {
		this.rows = rows;
	}
