...
public class Pgt00322Action extends ActionSupport implements SessionAware{
	...
	//Bean数组
	private ArrayList<Pgv00322> rows;
	...
	public String query() throws Exception {
		...
		try { 
			...
			//执行查询
			rows = t00322Service.LoadAll(v00322);
	...
	public String createByAjax() throws Exception{
		...
		try {
			if(!Constant.MOD_CREATE.equals(getACT())){
				//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
				//取得用户选中的数据信息
				t00322.setLc(ConvertUtil.toShort(txtLC));
				t00322.setCd00001Fwlx(txtFWLX);
				//t00355.setYwdt(YWDT);
				t00322.setZcs(ConvertUtil.toShort(txtZCS));
...
/*********************** set and get ******************************/
	...
	*/
	 ...
	 * @return the rows
	 */
	public ArrayList<Pgv00322> getRows() {
		return rows;
	}
	 ...
	 */
	public void setRows(ArrayList<Pgv00322> rows) {
		this.rows = rows;
	}
