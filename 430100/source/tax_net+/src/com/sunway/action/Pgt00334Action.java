...
public class Pgt00334Action extends ActionSupport {
	...
	private ArrayList<Pgt00334> rows;
	...
	public String execute() throws Exception {
		...
		try {
			rows = t00334Service.LoadAll(new Pgt00334(txtFCID, txtPSSD));
			readInfo();
	...
	public String execute_B() throws Exception {
		...
		try {
			rows = t00334Service.LoadAll_B(new Pgt00334(txtFCID, txtPSSD));
			readInfo_B();
	 ...
	 * @return the rows
	 */
	public ArrayList<Pgt00334> getRows() {
		return rows;
	}
	 ...
	 *            the rows to set
	 */
	public void setRows(ArrayList<Pgt00334> rows) {
		this.rows = rows;
	}
