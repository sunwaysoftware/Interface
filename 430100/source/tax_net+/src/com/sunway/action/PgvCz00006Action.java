...
public class PgvCz00006Action extends ActionSupport {
	...
	private ArrayList<PgvCz00006> rows;
	...
	public String queryByUpdate() throws Exception {
		rows = cz00006Service.LoadByUpdate();
		return SUCCESS;	
	}
	...
	public String queryByDelete() throws Exception {
		rows = cz00006Service.LoadByDelete();
		return SUCCESS;	
	}
	 ...
	 */
	public void setRows(ArrayList<PgvCz00006> rows) {
		this.rows = rows;
	}
	 ...
	 * @return the rows
	 */
	public ArrayList<PgvCz00006> getRows() {
		return rows;
	}
}