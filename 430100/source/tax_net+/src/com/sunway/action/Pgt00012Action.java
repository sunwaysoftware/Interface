...
public class Pgt00012Action extends ActionSupport implements SessionAware {
	...
	public void validateUpdate() throws Exception{
		...
		t00012Bean = t00012Service.LoadByPrimaryKey(t00012Bean);
		//判读数据是否已经被其他用户修改
//		if((Constant.MOD_UPDATE.equals(getACT()))&&(!t00012Bean.getUpddate().equals(ConvertUtil.toTimestamp(txtUPDATE)))) {
...
//		}else{
		//为数据BEAN 赋值
			...
			t00012Bean.setFcjkdz(CheckUtil.chkTrim(txtFCJKDZ));
			t00012Bean.setChannel_Pwd(CheckUtil.chkTrim(txtCHANNEL_PWD));
			t00012Bean.setChannel_Acc(CheckUtil.chkTrim(txtCHANNEL_ACC));
			t00012Bean.setChannel_Code(CheckUtil.chkTrim(txtCHANNEL_CODE));
			t00012Bean.setWbmbm(CheckUtil.chkTrim(txtWBMBM));
			t00012Bean.setFcbmbm(CheckUtil.chkTrim(txtFCBM));
//		}
