...
public class Pgt00304Action extends ActionSupport implements SessionAware {
	...
	// Bean数组
	private ArrayList<Pgv00304> rows;
	...
	public String query() throws Exception {
		...
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			// 准备查询条件
			v00304.setSwid(CheckUtil.chkTrim(txtSWIDFind));
			v00304.setNsrmc(FormatUtil.toSearchLike(txtNSRMCFind));
			v00304.setCd00352Xqdm(CheckUtil.chkTrim(txtXQFind));
			v00304.setFwtdzl(FormatUtil.toSearchLike(txtFWTDZLFind));
			...
			// 执行查询
			rows = t00304Service.LoadAll(v00304);
	...
	public void validateUpdate() throws Exception {
		...
		if ((Constant.MOD_UPDATE.equals(getACT()))
			...
			t00304Bean.setZlc(ConvertUtil.toShort(txtZLC));
			...
			t00304Bean.setJzmj(ConvertUtil.toBigDecimal(txtJZMJ));
			t00304Bean.setCd00001Fwcx(txtFWCX);
			t00304Bean.setCd00001Cgzk(txtCGZK);
			t00304Bean.setSzlc(ConvertUtil.toShort(txtSZLC));
			t00304Bean.setBwjfh(txtBWJFH);
			t00304Bean.setZbjg(ConvertUtil.toBigDecimal(txtZBJG));
			t00304Bean.setTdsyqmj(CheckUtil.chkNull(txtTDSYQMJ));
			t00304Bean.setSfzj(rdoSFZJ);
			t00304Bean.setGpsj(ConvertUtil.toUtilDate(txtGPSJ));
	...
	*/
	...
	public String detail() throws Exception {
		...
		try {
			// 准备查询条件
			v00304.setGpid(ConvertUtil.encoding(SWID));
			// 执行查询
	 ...
	 * @return the rows
	 */
	public ArrayList<Pgv00304> getRows() {
		return rows;
	}
	/**
	 * @param rows the rows to set
	 */
	public void setRows(ArrayList<Pgv00304> rows) {
		this.rows = rows;
	}
	/**
