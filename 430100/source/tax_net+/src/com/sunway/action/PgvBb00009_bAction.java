...
public class PgvBb00009_bAction extends ActionSupport implements SessionAware {
	...
	public String query() throws Exception {
		...
		try {
			//sessionCtrl = new SessionCtrl(ActionContext.getContext().getSession());
			// 准备查询条件
			bb00009_b.setCd00002Pssd(ConvertUtil.encoding(CheckUtil.chkTrim(ddlPSSDFind)));
			bb00009_b.setCd00001Ssgx(ConvertUtil.encoding(CheckUtil.chkTrim(ddlSSGXFind)));
			bb00009_b.setSfssgx(CheckUtil.chkNull(chkSFSSGX));
