...
public class Pgt00351Action extends ActionSupport implements SessionAware {
	...
	private ArrayList<Pgv00351a> rowsA;
...
//测算与不可测算用	
	...
	public String execute() throws Exception {
		...
		try {
			txtJYSJFind =MakeUtil.currentDate();
			ReadInfo();			
		} catch (Exception e) {
	...
	public String query() throws Exception {
		...
		try {
			// 准备查询条件
			v00351.setSlid(FormatUtil.toSearchLike(txtSLIDFind));
			v00351.setCd00001Szqy(ddlSZQYFind);
			v00351.setCd00352Xqdm(CheckUtil.chkTrim(txtXQFind));
			v00351.setZcdzl(FormatUtil.toSearchLike(txtZCDZL));
			v00351.setCd00001Fwlx(txtFWLX);
			if(null != txtJYSJFind && !"".equals(txtJYSJFind)){
				v00351.setJysj(ConvertUtil.toUtilDate(txtJYSJFind));
			}else{
				v00351.setJysj(ConvertUtil.toUtilDate(MakeUtil.currentDate()));
			}
			...
			// 执行查询
			rows = t00351Service.LoadAll(v00351);
			// 分页设置
...
/**
	...
	public String create() throws Exception {
		...
		try {
			if (!Constant.MOD_CREATE.equals(getACT())) {
				// 取得用户选中的数据信息
				t00351.setSlid(SLID);
				bean = t00351Service.LoadByPrimaryKey(t00351);
				...
				bean.setZcdzl(v00303Bean.getZcdzl());
	...
	public void validateUpdate() throws Exception {
		...
		if (Constant.MOD_UPDATE.equals(getACT())) {
			bean = t00351Service.LoadByPrimaryKey(bean);
		}
		// 判读数据是否已经被其他用户修改
		if ((Constant.MOD_UPDATE.equals(getACT()))
			...
			bean.setPfmjg(CheckUtil.chkNull(txtPFMJG));
			bean.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
			bean.setNote(txtNOTET00351);
	...
	public String update() throws Exception {
		...
		try {
			if (Constant.MOD_CREATE.equals(getACT())) { // Create
				if (t00351Service.GetInsertCommand(bean)) {
					txtFale = "1";
				...
				if (t00351Service.GetUpdateCommand(bean)) {
					bean = t00351Service.LoadByPrimaryKey(bean);
					this.addActionMessage(getText(Constant.MSG_UPDATE_OK, new String[] { bean.getSlid() }));
				} else {
					this.addActionError(getText(Constant.MSG_UPDATE_NG, new String[] { bean.getSlid() }));
				}
			} else if (Constant.MOD_DELETE.equals(getACT())) { // Delete
				if (t00351Service.GetDeleteCommand(bean)) {
					this.addActionMessage(getText(Constant.MSG_DELETE_OK, new String[] { bean.getSlid() }));
					rtn = "successDEL";
				} else {
					this.addActionError(getText(Constant.MSG_DELETE_NG, new String[] { bean.getSlid() }));
				}
			}
		} catch (Exception e) {
			LOG.error(e.getMessage());
	...
	public String detail() throws Exception {
		...
		try {
			// 准备查询条件
			v00351.setSlid(ConvertUtil.encoding(SLID));
			// 执行查询
			v00351a.setPageIndex(1);
			v00351a.setPageSize(-1);
			v00351a.setCd00351Slid(CheckUtil.chkTrim(SLID));
			// 执行查询
			v00351Bean = t00351Service.LoadDetail(v00351);
			// 执行查询
			rowsA = t00351aService.LoadAll(v00351a);
		} catch (Exception e) {
			LOG.error(e.getMessage());
			this.addActionError(e.getMessage());
			return ERROR;
	...
	public String detailGS() throws Exception {
		...
		try {
			// 准备查询条件
			t00351a.setSlid(ConvertUtil.encoding(SLID));
			rowsA = t00351aService.LoadByPrimaryKey(t00351a);
			if(rowsA.size()>0){
				v00351.setSlid(rowsA.get(0).getCd00351Slid());
			}
	...
	public String createBzf() throws Exception{
		...
		try {
			// 准备查询条件
			t00351.setCd00001Szqy(ConvertUtil.encoding(ddlSZQYFind));
			t00351.setCd00352Xqdm(txtXQDM);
//			t00351.setCd00001Fwlx(ConvertUtil.encoding(txtFWLX));
	...
	public String importBzf() throws Exception{
		...
		try {
			// 准备查询条件
			t00351.setCd00001Szqy(ConvertUtil.encoding(ddlSZQYFind));
			t00351.setCd00352Xqdm(ConvertUtil.encoding(txtXQDM));
			//t00351.setCd00001Fwlx(ConvertUtil.encoding(txtFWLX));
			t00351.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
			t00351.setSsgx(sessionCtrl.Get(SessionCtrl.SESSION_KEY_SSGX));
			// 执行查询
	...
	public String findY()throws Exception{
		...
		try{
			...
			v00351.setCd00001Szqy(ddlSZQYFind);
			v00351.setSsgx(sessionCtrl.Get(SessionCtrl.SESSION_KEY_SSGX));
			v00351.setCd00001Fwlx(ConvertUtil.encoding(txtFWLX));
			v00351.setMonthSet(ConvertUtil.toInteger(txtCSYF));
			v00351.setIsYwjg(rdoYWJG);
			v00351.setXqnm(FormatUtil.toSearchLike(txtXQCX));
			
			rows = t00351Service.findY(v00351);
	...
	public String findN()throws Exception{
		...
		try{
			...
			v00351.setCd00001Fwlx(ConvertUtil.encoding(txtFWLX));
			v00351.setMonthSet(ConvertUtil.toInteger(txtCSYF));
			v00351.setBzfjg(ConvertUtil.toInteger(txtYWJG));
			v00351.setZcdzl(FormatUtil.toSearchLike(txtZCDZL));
			rows = t00351Service.findN(v00351);
...
/**************************************   信息导出     *********************************************/
	...
	public String exportN()throws Exception{
		...
		try{
			...
			v00351.setCd00001Szqy(ConvertUtil.encoding(ddlSZQYFind));
			v00351.setSsgx(sessionCtrl.Get(SessionCtrl.SESSION_KEY_SSGX));
			v00351.setCd00001Fwlx(ConvertUtil.encoding(txtFWLX));
			v00351.setBzfjg(ConvertUtil.toInteger(txtBZFJG));
			v00351.setMonthSet(ConvertUtil.toInteger(txtCSYFE));
	...
	public String executeCS()throws Exception{
		...
		try{
			...
			case 1:
				...
				for(Integer i = 0;i < csTotal;i++){
					try{
						...
						v00351.setZj(txtZJ);
						v00351.setJysj(ConvertUtil.toUtilDate(CheckUtil.chkTrim(txtCSJYSJ)));
						v00351.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
						v00351.setMonthSet(ConvertUtil.toInteger(txtMONTHFind));
			...
			case 2:
				...
				v00351.setMonthSet(ConvertUtil.toInteger(txtMONTHFind));
				v00351.setIsYwjg((ConvertUtil.toInteger(txtYWJG)));
				v00351.setZcdzl(FormatUtil.toSearchLike(txtZCDZL));
				...
				for(Integer i = 0;i < csTotal;i++){
					try{
						...
						v00351.setJysj(ConvertUtil.toUtilDate(CheckUtil.chkTrim(txtCSJYSJ)));
						//v00351.setCd00002Czr(rows.get(i).getCd00002Czr());
						v00351.setCd00002Czr(sessionCtrl.Get(SessionCtrl.SESSION_KEY_USERID));
						v00351.setCjal(txtCJAL);
						v00351.setGpal(txtGPAL);
						v00351.setYsf(txtYSF);
	 ...
	 * @return the rowsA
	 */
	public ArrayList<Pgv00351a> getRowsA() {
		return rowsA;
	}

	/**
	 * @param rowsA the rowsA to set
	 */
	public void setRowsA(ArrayList<Pgv00351a> rowsA) {
		this.rowsA = rowsA;
	}
	...
	public Pgt00351 getBean() {
		return bean;
	}

	public void setBean(Pgt00351 bean) {
		this.bean = bean;
	}
