...
public class Pgt00351aAction extends ActionSupport implements SessionAware{
	...
	private ArrayList<Pgv00351a> rows;
	private String SLID;
	// 提交数据
	...
	public String query() throws Exception {
		...
		try {
			...
			// 执行查询
			rows = t00351aService.LoadAll(v00351a);
			// 分页设置
	...
	public void validateUpdate() throws Exception {
		...
		t00351a.setSlid(CheckUtil.chkTrim(DSLID));
		t00351a.setJysj(ConvertUtil.toUtilDate(txtJYSJ));
		t00351a.setPfmjg(ConvertUtil.toDouble(txtPFMJG));
	 ...
	 * @return the rows
	 */
	public ArrayList<Pgv00351a> getRows() {
		return rows;
	}
	/**
	 * @param rows the rows to set
	 */
	public void setRows(ArrayList<Pgv00351a> rows) {
		this.rows = rows;
	}
	/**
	 * @return the sLID
