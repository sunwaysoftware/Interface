...
public class Pgv02020 extends BaseVO {
    ...
    private ArrayList<Pgv02020> outList;
	...
	public ArrayList<Pgv02020> getOutList() {
		return outList;
	}
	public void setOutList(ArrayList<Pgv02020> outList) {
	...
	public String getCd02020aId() {
		return cd02020aId;
	}
	public void setCd02020aId(String cd02020aId) {
		this.cd02020aId = cd02020aId;
	}
