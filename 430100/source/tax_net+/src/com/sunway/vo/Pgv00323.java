...
public class Pgv00323 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = 5159642003843832461L;
	private Short lc;
	private Short zcs;
    ...
    private ArrayList<Pgv00323> outList;
	// Constructors
    private String cwxx;
    ...
    public Pgv00323(){
    	...
    	this.outList=new ArrayList<Pgv00323>();
    }
	/**
	 * @return the lc
	 */
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00323> getOutList() {
		return outList;
	}
	/**
	 * @param outList the outList to set
	 */
	public void setOutList(ArrayList<Pgv00323> outList) {
