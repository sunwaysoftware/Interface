...
public class Pgv00322 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = 298294941325784350L;
	private Short lc;
	private Short zcs;
    ...
    private ArrayList<Pgv00322> outList;
	// Constructors
    private String cwxx;
    ...
    public Pgv00322(){
    	...
    	this.outList=new ArrayList<Pgv00322>();
    }
	/**
	 * @return the lc
	 */
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00322> getOutList() {
		return outList;
	}
	/**
	 * @param outList the outList to set
	 */
	public void setOutList(ArrayList<Pgv00322> outList) {
