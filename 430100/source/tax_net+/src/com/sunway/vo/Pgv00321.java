...
public class Pgv00321 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = 5714341885880878007L;
	private Short lc;
	private Short zcs;
    ...
    private ArrayList<Pgv00321> outList;
	// Constructors
    private String cwxx;
    ...
    public Pgv00321(){
    	...
    	this.outList=new ArrayList<Pgv00321>();
    }
	/**
	 * @return the lc
	 */
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00321> getOutList() {
		return outList;
	}
	/**
	 * @param outList the outList to set
	 */
	public void setOutList(ArrayList<Pgv00321> outList) {
