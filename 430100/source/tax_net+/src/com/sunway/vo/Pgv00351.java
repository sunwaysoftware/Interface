...
public class Pgv00351 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = 2530212993736061397L;
	...
	private ArrayList<Pgv00351> outList;
	...
	private String ywdt1;
	private Integer isYwjg;
	private String cjal;
	private String gpal;
	private String ysf;
	private String zj;
	/** default constructor */
	public Pgv00351() {
		outList = new ArrayList<Pgv00351>();
	}
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00351> getOutList() {
		return outList;
	}
	 ...
	 */
	public void setOutList(ArrayList<Pgv00351> outList) {
...
//	}
	...
	public String getYwdt1() {
		return ywdt1;
	}

	public void setYwdt1(String ywdt1) {
		this.ywdt1 = ywdt1;
	}
	 ...
	 * @return the isYwjg
	 */
	public Integer getIsYwjg() {
		return isYwjg;
	}

	/**
	 * @param isYwjg the isYwjg to set
	 */
	public void setIsYwjg(Integer isYwjg) {
		this.isYwjg = isYwjg;
	}

	public String getCjal() {
		return cjal;
	}

	public void setCjal(String cjal) {
		this.cjal = cjal;
	}

	public String getGpal() {
		return gpal;
	}

	public void setGpal(String gpal) {
		this.gpal = gpal;
	}
