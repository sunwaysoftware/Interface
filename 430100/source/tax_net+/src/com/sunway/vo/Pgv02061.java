...
public class Pgv02061 extends BaseVO implements java.io.Serializable {
	...
	private ArrayList<Pgv02061> outList;
	...
	private Double gpqz;
	private Double gpxf;
	private Double dypfmjg;
	private String zhxz;
	private String parentnm;
	private String jysjMonth;
	
	private String qdh;
	private String bwjfh;
	private String zh;
	private String cd00001Fqwz;
	private String cd00001Dywz;
	private String fqwz;
	private String dywz;
	private String qyxz;
	private Integer monthSet;
	private Integer bzfjg;
	private String jcsj;
	private Integer slks;
	private Timestamp cssj;
	private Timestamp kbslkJysjs;
	private Timestamp kbslkJysje;
	private Timestamp kbslkImps;
	private Timestamp kbslkImpe;
	private Date jysjMin;
	private Date jysjMax;	
	private Integer sfsc; //是否是市场法 1，是； 0，不是
	...
	/** default constructor */
	public Pgv02061() {
		outList = new ArrayList<Pgv02061>();
	}
	...
	/**
	 * @param slCount the slCount to set
	 */
	...
	/**
	 * @param gpCount the gpCount to set
	 */
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv02061> getOutList() {
		return outList;
	}
	 ...
	 */
	public void setOutList(ArrayList<Pgv02061> outList) {
	 ...
	 */
	public void setGpqz(Double gpqz) {
		this.gpqz = gpqz;
	}
	 ...
	 * @return the gpxf
	 */
	public Double getGpxf() {
		return gpxf;
	}

	/**
	 * @param gpxf the gpxf to set
	 */
	public void setGpxf(Double gpxf) {
		this.gpxf = gpxf;
	}
	...
	/**
	 * @param dypfmjg the dypfmjg to set
	 */
	...
	/**
	 * @return the jysjMonth
	 */
	public String getJysjMonth() {
		return jysjMonth;
	}

	/**
	 * @param jysjMonth the jysjMonth to set
	 */
	public void setJysjMonth(String jysjMonth) {
		this.jysjMonth = jysjMonth;
	}
	...
	/**
	 * @return the cd00001Fqwz
	 */
	public String getCd00001Fqwz() {
		return cd00001Fqwz;
	}

	/**
	 * @param cd00001Fqwz the cd00001Fqwz to set
	 */
	public void setCd00001Fqwz(String cd00001Fqwz) {
		this.cd00001Fqwz = cd00001Fqwz;
	}

	/**
	 * @return the cd00001Dywz
	 */
	public String getCd00001Dywz() {
		return cd00001Dywz;
	}

	/**
	 * @param cd00001Dywz the cd00001Dywz to set
	 */
	public void setCd00001Dywz(String cd00001Dywz) {
		this.cd00001Dywz = cd00001Dywz;
	}
	...
	public Integer getBzfjg() {
		return bzfjg;
	}

	public void setBzfjg(Integer bzfjg) {
		this.bzfjg = bzfjg;
	}

	public Integer getSlks() {
		return slks;
	}

	public void setSlks(Integer slks) {
		this.slks = slks;
	}
	...
	public Timestamp getKbslkJysjs() {
		return kbslkJysjs;
	}

	public void setKbslkJysjs(Timestamp kbslkJysjs) {
		this.kbslkJysjs = kbslkJysjs;
	}

	public Timestamp getKbslkJysje() {
		return kbslkJysje;
	}

	public void setKbslkJysje(Timestamp kbslkJysje) {
		this.kbslkJysje = kbslkJysje;
	}

	public Timestamp getKbslkImps() {
		return kbslkImps;
	}

	public void setKbslkImps(Timestamp kbslkImps) {
		this.kbslkImps = kbslkImps;
	}

	public Timestamp getKbslkImpe() {
		return kbslkImpe;
	}

	public void setKbslkImpe(Timestamp kbslkImpe) {
		this.kbslkImpe = kbslkImpe;
	}
