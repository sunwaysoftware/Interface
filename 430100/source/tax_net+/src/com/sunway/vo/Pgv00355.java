...
public class Pgv00355 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = -7835359942535478136L;
	private Short lc;
	private Short zcs;
    ...
    private ArrayList<Pgv00355> outList;
	// Constructors
    private String cwxx;
    ...
    public Pgv00355(){
    	...
    	this.outList=new ArrayList<Pgv00355>();
    }
	/**
	 * @return the lc
	 */
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00355> getOutList() {
		return outList;
	}
	/**
	 * @param outList the outList to set
	 */
	public void setOutList(ArrayList<Pgv00355> outList) {
