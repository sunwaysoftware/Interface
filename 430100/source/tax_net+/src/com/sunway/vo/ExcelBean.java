...
public class ExcelBean implements java.io.Serializable{
	...
	private String qdh;
	private String dmh;
	private String parentDmh;
	private String dmhId;
	private String parengDmhId;
	...
	/**
	 * @return the parentDmh
	 */
	public String getParentDmh() {
		return parentDmh;
	}

	/**
	 * @param parentDmh the parentDmh to set
	 */
	public void setParentDmh(String parentDmh) {
		this.parentDmh = parentDmh;
	}
	...
	/**
	 * @return the parengDmhId
	 */
	public String getParengDmhId() {
		return parengDmhId;
	}

	/**
	 * @param parengDmhId the parengDmhId to set
	 */
	public void setParengDmhId(String parengDmhId) {
		this.parengDmhId = parengDmhId;
	}
