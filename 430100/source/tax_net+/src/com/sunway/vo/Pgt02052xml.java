...
public class Pgt02052xml extends BaseVO implements java.io.Serializable {


	private static final long serialVersionUID = 5961410787215645821L;
	private ArrayList<Pgt02052xml> pgt02052XmlList;
...
//	private Double pgjgView;
	...
	/** default constructor */
	public Pgt02052xml() {
		this.pgt02052XmlList = new ArrayList<Pgt02052xml>();
	}
	/** full constructor */
	public Pgt02052xml(	
...
//	}
	...
	/**
	 * @return the pgt02052XmlList
	 */
	public ArrayList<Pgt02052xml> getPgt02052XmlList() {
		return pgt02052XmlList;
	}
	/**
	 * @param pgt02052XmlList the pgt02052XmlList to set
	 */
	public void setPgt02052XmlList(ArrayList<Pgt02052xml> pgt02052XmlList) {
		this.pgt02052XmlList = pgt02052XmlList;
	}
	/**
	 * @return the zrfTel
	 */
