...
public class Pgv00304 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = -2935948748862773882L;
	private String gpid;
	private String swid;
    ...
    private ArrayList<Pgv00304> outList;
    private String qtxzId;
	// Constructors

	/** default constructor */
	public Pgv00304() {
		outList = new ArrayList<Pgv00304>();
	}
	 ...
	 * @return the outList
	 */
	public ArrayList<Pgv00304> getOutList() {
		return outList;
	}
	 ...
	 */
	public void setOutList(ArrayList<Pgv00304> outList) {
