...
/**
 * Pgv00331Id entity. @author MyEclipse Persistence Tools
 */


public class Pgv00331 extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = 1974185042777032513L;
	private String cd00302Fcid;
	private String cd00002Pssdy;
	private Double pgjg;
	private Date cd00002Pssd;
	...
	private Integer isCqts;
	private Double scpgjg;
	private String zjhm;
	private String fcslh;
	private Integer scdjzzt;
	 ...
	 * @param pgCzr
	 */
	public Pgv00331(String cd00302Fcid, Double pgjg, String cd00301Swid,
			String nsrmc, Double gbpgjg, Integer recordCount,
			Integer recordIndex, String pgCzr, Integer isCqts, Double scpgjg, String zjhm) {
	 ...
	 */
	public void setCd00002Pssd(Date cd00002Pssd) {
	 ...
	 * @return the lcxz
	 */
	public Double getLcxz() {
		return lcxz;
	}

	/**
	 * @param lcxz the lcxz to set
	 */
	public void setLcxz(Double lcxz) {
		this.lcxz = lcxz;
	}
	 ...
	 * @return the cxxz
	 */
	public Double getCxxz() {
		return cxxz;
	}

	/**
	 * @param cxxz the cxxz to set
	 */
	public void setCxxz(Double cxxz) {
		this.cxxz = cxxz;
	}
	 ...
	 * @return the cgxz
	 */
	public Double getCgxz() {
		return cgxz;
	}

	/**
	 * @param cgxz the cgxz to set
	 */
	public void setCgxz(Double cgxz) {
		this.cgxz = cgxz;
	}
	...
	/**
	 * @param isCqts the isCqts to set
	 */
	public void setIsCqts(Integer isCqts) {
		this.isCqts = isCqts;
	}
	...
	public Integer getScdjzzt() {
		return scdjzzt;
	}

	public void setScdjzzt(Integer scdjzzt) {
		this.scdjzzt = scdjzzt;
	}
