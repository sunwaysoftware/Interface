...
public class Pgv00302_b extends BaseVO implements java.io.Serializable {

	private static final long serialVersionUID = -7993461143597252815L;
	private String fcid;
	private String cd00301BSwid;
	...
	private ArrayList<Pgv00302_b> v00302_bList;

	/** default constructor */
	public Pgv00302_b() {
		this.v00302_bList = new ArrayList<Pgv00302_b>();
	}
	...
	/**
	 * @return the cd00301BSwid
	 */
	public String getCd00301BSwid() {
		return cd00301BSwid;
	}
	/**
	 * @param cd00301bSwid the cd00301BSwid to set
	 */
	public void setCd00301BSwid(String cd00301bSwid) {
		cd00301BSwid = cd00301bSwid;
	}
	/**
	...
	/**
	 * @return the v00302_bList
	 */
	public ArrayList<Pgv00302_b> getV00302_bList() {
		return v00302_bList;
	}
	/**
	 * @param v00302BList the v00302_bList to set
	 */
	public void setV00302_bList(ArrayList<Pgv00302_b> v00302BList) {
		v00302_bList = v00302BList;
	}
}
