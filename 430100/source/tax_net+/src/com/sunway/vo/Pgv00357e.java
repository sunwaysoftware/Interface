...
public class Pgv00357e implements java.io.Serializable {

	private static final long serialVersionUID = 5881216886360202851L;
	private String cd00357Slid;
	...
	/** minimal constructor */
	public Pgv00357e(String cd00357Slid, String cd00053Qtxzid, Date upddate,
			String cd00002Czr, String qtxznm, Byte xzlx, Double xzxs) {
		this.cd00357Slid = cd00357Slid;
	...
	/**
	 * @return the cd00357Slid
	 */
	public String getCd00357Slid() {
		return cd00357Slid;
	}
	/**
	 * @param cd00357Slid the cd00357Slid to set
	 */
	public void setCd00357Slid(String cd00357Slid) {
		this.cd00357Slid = cd00357Slid;
	}
	/**
