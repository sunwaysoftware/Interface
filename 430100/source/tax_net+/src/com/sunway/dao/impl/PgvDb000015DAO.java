 ...
 * @version 1.0
 */
public class PgvDb000015DAO extends BaseDAO implements IPgvDb000015DAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvDb000015DAO#LoadAll(com.sunway.vo.PgvDb000015)
	 */
	
	@Override
	public PgvDb000015 LoadAll(PgvDb000015 db000015) throws Exception {
		PgvDb000015 listResult = new PgvDb000015();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_DB_000015(?,?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			call.registerOutParameter(2, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(3, db000015.getCd00002Pssd());
			call.setString(4, db000015.getCd00001Ssgx());
			call.setDouble(5, db000015.getJsbl());
			call.setDouble(6, db000015.getSl());
			call.execute();
			//返回列合
			...
			while (null != rs && rs.next()) {
				listResult.getDb000015List().add(SetVParameters(rs));
			}
		} catch (Exception e) {
			throw e;
		} finally {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvDb000015DAO#GetInsertCommand(com.sunway.vo.PgvDb000015)
	 */
	...
	public boolean GetInsertCommand(PgvDb000015 db000015) throws Exception {
		...
		try {
			...
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_ADDT100405(?,?,?)}");
			// 传入输入参数
			call.setString(1, db000015.getCd00002Pssd());
			call.setString(2, db000015.getCd00001Ssgx());
			call.setString(3, db000015.getCd00002Czr());
			call.execute();
			tran.commit();
			bResult = true;
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	protected PgvDb000015 SetVParameters(ResultSet rs) throws Exception {
		PgvDb000015 e = new PgvDb000015();
