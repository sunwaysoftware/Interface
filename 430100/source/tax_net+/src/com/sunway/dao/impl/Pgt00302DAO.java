...
//	private static final String ynze = "YNZE";
	...
	public ArrayList<Pgv00302> LoadAllE(Pgv00302 v00302) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETT00302E(?,?)}");
			// 注册输出参数
			call.registerOutParameter(1, OracleTypes.CURSOR);
			// 传入输入参数
	...
	public ArrayList<Pgv00302> LoadAllE_B(Pgv00302 v00302) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETT00302E_B(?,?)}");
			// 注册输出参数
			call.registerOutParameter(1, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(2, v00302.getFcid());
	...
	public boolean GetInsertCommand(Pgt00302 t00302) throws Exception {
		...
		try {
			...
			call.setBigDecimal(12, t00302.getJzmj());
			call.setShort(13, t00302.getSzlc());
			call.setString(14, t00302.getBwjfh());
			call.setBigDecimal(15, t00302.getJyjg());
			call.setDouble(16, t00302.getTdsyqmj());
			call.setDouble(17, t00302.getRjl());
			...
			call.setDate(28, ConvertUtil.utilDateToSqlDate(t00302.getDjrq()));
			call.setString(29, t00302.getShr());
			call.setString(30, t00302.getCd00352Xqdm());
			call.setString(31, t00302.getCd00001Jzjg1());
			call.setBoolean(32, CheckUtil.chkNull(t00302.getYwdt()));
			call.setShort(33, t00302.getZlc());
			...
			call.setBoolean(45, CheckUtil.chkNull(t00302.getYwjkc()));
			...
			call.setInt(50, t00302.getOinsid());
			call.setDouble(51, t00302.getYjg());
			call.setDouble(52, t00302.getSbpgjg());
			call.setString(53, t00302.getRoomid());
			call.setString(54, t00302.getOwnRoomid());
			call.setInt(55, t00302.getSfsyfc());
			call.setString(56, t00302.getLh());
			call.setString(57, t00302.getDyh());
			call.setInt(58, t00302.getIsExistQmpg());
			call.setString(59, t00302.getCsflxdh());
			call.setDate(60, ConvertUtil.utilDateToSqlDate(t00302.getWsrq()));
			call.setDouble(61, t00302.getWsjs());
			...
			call.setInt(66, t00302.getNsrLx_zr());
			call.setInt(67, t00302.getNsrLx_cs());
			call.setDate(68, ConvertUtil.utilDateToSqlDate(t00302.getHtqdsj()));
			call.setString(69, t00302.getId());
			call.setString(70, t00302.getHtbh());
			call.execute();
			tran.commit();
			bResult = true;
		} catch (Exception e) {
	...
	public boolean GetInsertCommandBySFZ(Pgt00302 t00302) throws Exception {
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_ADDT00371A_TEMP0(?)}");
	...
	public boolean GetUpdateCommand(Pgt00302 t00302) throws Exception {
		...
		try {
			...
			call.setBigDecimal(7, t00302.getJzmj());
//			call.setString(8, t00302.getCd00001Fwcx());
//			call.setString(9, t00302.getCd00001Cgzk());
			call.setShort(8, t00302.getSzlc());
			call.setString(9, t00302.getBwjfh());
			call.setBigDecimal(10, t00302.getJyjg());
			call.setDouble(11, t00302.getTdsyqmj());
			call.setDouble(12, t00302.getRjl());
			...
			call.setDate(23, ConvertUtil.utilDateToSqlDate(t00302.getDjrq()));
...
//			call.setString(29, t00302.getCd00001Zxzk());
			...
			call.setBoolean(27, CheckUtil.chkNull(t00302.getYwdt()));
			call.setShort(28, t00302.getZlc());
			...
			call.setDate(34, ConvertUtil.utilDateToSqlDate(t00302.getBgsj()));
			call.setInt(35, t00302.getBglx());
			call.setString(36, t00302.getZhxz());
			call.setString(37, t00302.getClh());
			call.setBoolean(38, CheckUtil.chkNull(t00302.getYwjkc()));
			...
			call.setDouble(43, t00302.getYjg());
			call.setDouble(44, t00302.getSbpgjg());
			call.setString(45,t00302.getLh());
			call.setString(46,t00302.getDyh());
			call.setInt(47, t00302.getIsExistQmpg());
			call.setInt(48, t00302.getSfsyfc());
			call.setString(49, t00302.getCsflxdh());
			call.setDate(50, ConvertUtil.utilDateToSqlDate(t00302.getWsrq()));
			call.setDouble(51, t00302.getWsjs());
			...
			call.setInt(56, t00302.getNsrLx_zr());
			call.setInt(57, t00302.getNsrLx_cs());
			call.setDate(58, ConvertUtil.utilDateToSqlDate(t00302.getHtqdsj()));
			call.setString(59, t00302.getHtbh());
			call.execute();
			tran.commit();
			bResult = true;
		} catch (Exception e) {
	...
	public boolean GetDeleteCommand(Pgt00302 t00302) throws Exception {
		...
		try {
			...
			call.setDate(4, ConvertUtil.utilDateToSqlDate(t00302.getBgsj()));
	...
	public Pgv00302 LoadPgv003025(Pgv00302 v00302) throws Exception {
		...
		try {
			...
			call.setDate(23, ConvertUtil.utilDateToSqlDate(v00302.getDjrq()));
			call.setDate(24, ConvertUtil.utilDateToSqlDate(v00302.getJysj_min()));
			call.setDate(25, ConvertUtil.utilDateToSqlDate(v00302.getJysj_max()));
			call.setString(26, v00302.getCd00002Czr());
			call.setDate(27, ConvertUtil.utilDateToSqlDate(v00302.getUpddateS()));
			call.setDate(28, ConvertUtil.utilDateToSqlDate(v00302.getUpddateE()));
	...
	public Pgv00302 LoadPgv003025_B(Pgv00302 v00302) throws Exception {
		...
		try {
			...
			call.setDate(28, ConvertUtil.utilDateToSqlDate(v00302.getUpddateE()));
			call.setString(29, v00302.getFcslh());
			call.setDate(30, ConvertUtil.utilDateToSqlDate(v00302.getUpddateSRD()));
			call.setDate(31, ConvertUtil.utilDateToSqlDate(v00302.getUpddateERD()));
			call.execute();
			//返回列合
			rsSum = (ResultSet) call.getObject(2);
			while(null!=rsSum && rsSum.next()){
	...
	public ArrayList<Pgv00302> LoadPgv003025_B1(Pgv00302 v00302) throws Exception {
		...
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT00302_B2(?,?,?,?,?,?,?)}");
			call.registerOutParameter(1, OracleTypes.CURSOR);
			//传入输入参数
			call.setInt(2, v00302.getPageIndex());
			call.setInt(3, v00302.getPageSize());
			call.setString(4, v00302.getOrder());
			call.setString(5, v00302.getSort());
			call.setString(6, v00302.getSqlData());
			...
			rs = (ResultSet) call.getObject(1);
			while (null != rs && rs.next()) {
				listResult.add(SetV003025Parameters(rs));
			}
		} catch (Exception e) {
			throw e;
		} finally {
...
//			call.setString(17, t00302.getCd00001Cgzk());
			...
			call.setDate(21, ConvertUtil.utilDateToSqlDate(t00302.getJysj()));
			...
			call.setDate(31, ConvertUtil.utilDateToSqlDate(t00302.getDjrq()));
...
//			call.setString(37, t00302.getCd00001Zxzk());
			...
			call.setBoolean(35, CheckUtil.chkNull(t00302.getYwdt()));
			...
			call.setString(43, t00302.getZhxz());
			call.setBoolean(44, CheckUtil.chkNull(t00302.getYwjkc()));
			call.execute();
			tran.commit();
			//返回值
	...
	public OutputStream ExportCXSjcx(Pgv00302 v00302) throws Exception {
		...
		try {
			...
			call.setString(10, v00302.getCd00001Szqy());
			call.setString(11, v00302.getCd00001Ssgx());
			call.setInt(12, CheckUtil.chkNull(v00302.getSczt()));
			call.setString(13, v00302.getZcdzbm());
			call.setString(14, v00302.getFczh());
			call.setString(15, v00302.getCd00001Jzjg());
			call.setShort(16, v00302.getSzlc());
...
//					call.setString(10, kbslk.getCgzk());
					...
					call.setDate(30, ConvertUtil.utilDateToSqlDate(kbslk.getDjrq()));
		...
		try {
			...
			for(int i = 0; i < pgt00352xml.size();i++){
				...
				if(!" ".equals(t00352xml.getSfsyfcmc())){
					if("私有国土".equals(t00352xml.getSfsyfcmc()))
				...
				call.setDate(21, ConvertUtil.utilDateToSqlDate(t00352xml.getJYSJ()));
				call.setDate(22, ConvertUtil.utilDateToSqlDate(t00352xml.getFZRQ()));
				call.setString(23, t00352xml.getDF());
				call.setString(24, t00352xml.getCX());
				call.setString(25, t00352xml.getCG());
				call.setInt(26, ConvertUtil.toInteger(t00352xml.getOINSID()));
				...
				call.setDate(35, ConvertUtil.utilDateToSqlDate(t00352xml.getWsrq()));
...
//			}
	...
	public boolean GetUpdateCommandXML(Pgt00352xml pgt00352xml)
		...
		try{
			...
			call.setInt(12, ConvertUtil.toInteger(pgt00352xml.getSZLC()));
			...
			call.setDate(17, ConvertUtil.utilDateToSqlDate(pgt00352xml.getJYSJ()));
			...
			call.setDate(27, ConvertUtil.utilDateToSqlDate(pgt00352xml.getFZRQ()));
			call.setString(28, pgt00352xml.getShr());
			call.setString(29, pgt00352xml.getXqdm());
			call.setString(30, pgt00352xml.getJZJG());
			call.setInt(31, ConvertUtil.toInteger(pgt00352xml.getYwdt()));
			call.setInt(32, ConvertUtil.toInteger(pgt00352xml.getZLC()));
			...
			call.setInt(38, ConvertUtil.toInteger(pgt00352xml.getXqzt()));
			...
			call.setInt(44, ConvertUtil.toInteger(pgt00352xml.getYwjkc()));
			...
			call.setInt(49, ConvertUtil.toInteger(pgt00352xml.getOINSID()));
	...
	public boolean GetUpdateCommand371(Pgt00352xml pgt00352xml)
		...
		try{
			...
			call.setDate(21, ConvertUtil.utilDateToSqlDate(pgt00352xml.getJYSJ()));
			call.setDate(22, ConvertUtil.utilDateToSqlDate(pgt00352xml.getFZRQ()));
