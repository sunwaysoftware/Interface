 ...
 * @version 1.0
 */
public class PgvDb000016DAO extends BaseDAO implements IPgvDb000016DAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvDb000016DAO#LoadAll(com.sunway.vo.PgvDb000016)
	 */
	
	@Override
	public PgvDb000016 LoadAll(PgvDb000016 db000016) throws Exception {
		PgvDb000016 listResult = new PgvDb000016();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_DB_000016(?,?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			call.registerOutParameter(2, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(3, db000016.getCd00002Pssd());
			call.setString(4, db000016.getCd00001Ssgx());
			call.setDouble(5, db000016.getJsbl());
			call.setDouble(6, db000016.getSl());
			call.execute();
			//返回列合
			...
			while (null != rs && rs.next()) {
				listResult.getDb000016List().add(SetVParameters(rs));
			}
		} catch (Exception e) {
			throw e;
		} finally {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvDb000016DAO#GetInsertCommand(com.sunway.vo.PgvDb000016)
	 */
	...
	public boolean GetInsertCommand(PgvDb000016 db000016) throws Exception {
		...
		try {
			...
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_ADDT100406(?,?,?)}");
			// 传入输入参数
			call.setString(1, db000016.getCd00002Pssd());
			call.setString(2, db000016.getCd00001Ssgx());
			call.setString(3, db000016.getCd00002Czr());
			call.execute();
			tran.commit();
			bResult = true;
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	protected PgvDb000016 SetVParameters(ResultSet rs) throws Exception {
		PgvDb000016 e = new PgvDb000016();
