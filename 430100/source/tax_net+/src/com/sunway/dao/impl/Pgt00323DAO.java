 ...
 *
 */
public class Pgt00323DAO extends BaseDAO implements IPgt00323DAO {
	...
	public boolean GetDeleteCommand(Pgt00323 lcxz) throws Exception {
	...
	public boolean GetDeleteSelCommand(Pgv00323 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_DELT003231(?,?,?)}");
	...
	@Override
	public boolean GetInsertCommand(Pgt00323 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	...
	@Override
	public boolean GetUpdateCommand(Pgt00323 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	...
	@Override
	public ArrayList<Pgv00323> LoadAll(Pgv00323 lcxz) throws Exception {
		ArrayList<Pgv00323> listResult = new ArrayList<Pgv00323>();
		ResultSet rs = null;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT00323(?,?,?,?,?,?)}");
			//注册输出参数
	 ...
	 * @throws Exception
	 */
	protected Pgv00323 SetVParameters(ResultSet rs) throws Exception {
		Pgv00323 e = new Pgv00323();
	...
	@Override
	public Pgt00323 LoadByPrimaryKey(Pgt00323 lcxz) throws Exception {
		ArrayList<Pgt00323> listResult = new ArrayList<Pgt00323>();
		ResultSet rs = null;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	 ...
	 * @throws Exception
	 */
	protected Pgt00323 SetTParameters(ResultSet rs) throws Exception {
		Pgt00323 e = new Pgt00323();
...
//		//e.setYwdt(rs.getInt(YWDT));
	...
	public boolean ExecuteParamCopy(Pgt00323 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	...
	@Override
	public OutputStream ExportLXCZSjcx(Pgv00323 lcxz) throws Exception {
	...
	public Pgv00323 ImportExcelData(ArrayList<Pgv00323> ebList) throws Exception {
		...
		try{
			...
			conn = super.getConnection();
			tran = session.beginTransaction();
			call = conn.prepareCall("{call PGSP_ADDT003231(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			for(int i=0; i<ebList.size(); i++){
				Pgv00323 bean = ebList.get(i);
				try {//注册数据参数
					call.registerOutParameter(1, OracleTypes.CURSOR);
					//注册输出参数
