...
public class Pgt00352DAO extends BaseDAO implements IPgt00352DAO {
	...
	@Override
	public ArrayList<String> GetXQNM(Pgt00352 t00352) throws Exception {
	...
	@Override
	public boolean validateXqdmhmIsExist(Pgv00352 v00352) throws Exception {
		boolean bResult = false;
		Connection conn = null;
		Session session = null;
		CallableStatement call = null;
		try{
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{?=call FN_XQDMHMISEXIST(?,?)}");
			call.registerOutParameter(1, OracleTypes.NUMBER);
			call.setString(2, v00352.getXqdmh());
			call.setString(3, v00352.getCd00001Szqy());
			call.execute();
