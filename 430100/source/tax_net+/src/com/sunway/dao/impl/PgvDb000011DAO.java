 ...
 * @version 1.0
 */
public class PgvDb000011DAO extends BaseDAO implements IPgvDb000011DAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvDb000011DAO#LoadAll(com.sunway.vo.PgvDb000011)
	 */
	
	@Override
	public PgvDb000011 LoadAll(PgvDb000011 db000011) throws Exception {
		PgvDb000011 listResult = new PgvDb000011();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_DB_000011(?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			call.registerOutParameter(2, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(3, db000011.getCd00002Pssd());
			call.setString(4, db000011.getCd00001Ssgx());
			call.setString(5, db000011.getCd00002Czr());
			call.execute();
			//返回列合
			...
			while (null != rs && rs.next()) {
				listResult.getDb000011List().add(SetVParameters(rs));
			}
		} catch (Exception e) {
			throw e;
		} finally {
	 ...
	 * @throws Exception
	 */
	protected PgvDb000011 SetVParameters(ResultSet rs) throws Exception {
		PgvDb000011 e = new PgvDb000011();
