 ...
 * @version 1.0
 */
public class PgvBb00002_bDAO extends BaseDAO implements IPgvBb00002_bDAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvBb00002_bDAO#LoadAll(com.sunway.vo.PgvBb00002_b)
	 */
	
	@Override
	public ArrayList<PgvBb00002_b> LoadAll(PgvBb00002_b bb00002_b) throws Exception {
		ArrayList<PgvBb00002_b> listResult = new ArrayList<PgvBb00002_b>();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_BB_00002_B(?,?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(2, bb00002_b.getCd00001Ssgx());
			call.setString(3, bb00002_b.getCd00002Pssd());
			call.setBoolean(4, bb00002_b.getSfssgx());
			call.setString(5, bb00002_b.getCd00002Czr());
			call.execute();
			// 返回數據集
	 ...
	 * @throws Exception
	 */
	protected PgvBb00002_b SetVParameters(ResultSet rs) throws Exception {
		PgvBb00002_b e = new PgvBb00002_b();
