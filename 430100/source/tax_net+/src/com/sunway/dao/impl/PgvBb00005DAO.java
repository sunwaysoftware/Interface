 ...
 * @version 1.0
 */
public class PgvBb00005DAO extends BaseDAO implements IPgvBb00005DAO {
	...
	/*
	 * (non-Javadoc)
	 * @see com.sunway.dao.IPgvBb00005DAO#LoadAll(com.sunway.vo.PgvBb00005)
	 */
	
	@Override
	public ArrayList<PgvBb00005> LoadAll(PgvBb00005 bb00005) throws Exception {
		ArrayList<PgvBb00005> listResult = new ArrayList<PgvBb00005>();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_BB_00005(?,?,?,?)}");
			// 注冊輸出參數
			call.registerOutParameter(1, OracleTypes.CURSOR);
			// 传入输入参数
			call.setString(2, bb00005.getCd00001Ssgx());
			call.setString(3, bb00005.getCd00002Pssd());
			call.setString(4, bb00005.getCd00002Czr());
			call.execute();
			// 返回數據集
	 ...
	 * @throws Exception
	 */
	protected PgvBb00005 SetVParameters(ResultSet rs) throws Exception {
		PgvBb00005 e = new PgvBb00005();
