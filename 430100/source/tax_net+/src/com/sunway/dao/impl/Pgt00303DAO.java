...
//	private static final String csfzjlx="CSFZJLX";
	...
	public boolean GetInsertCommand(Pgt00303 t00303) throws Exception {
		...
		try {
			...
			call.setBoolean(4, CheckUtil.chkNull(t00303.getYwdt()));
			...
			call.setBoolean(12, CheckUtil.chkNull(t00303.getYwjkc()));
			call.execute();
			tran.commit();
			bResult = true;
		} catch (Exception e) {
	...
	public boolean GetHBCommand(Pgt00303 t00303) throws Exception {
		...
		try {
			...
			call.setBoolean(5, CheckUtil.chkNull(t00303.getYwdt()));
			...
			call.setBoolean(13, CheckUtil.chkNull(t00303.getYwjkc()));
			call.execute();
			tran.commit();
			bResult = true;
		} catch (Exception e) {
		...
		try{
			...
			for(int i=0; i<ebList.size(); i++){
				...
				try {
					...
					call.setShort(5, ConvertUtil.toShort("0"));
	...
	@Override
	public ArrayList<Pgv00303> readFwtdzl(Pgv00303 v00303) throws Exception {
		ArrayList<Pgv00303> listResult = new ArrayList<Pgv00303>();
		ResultSet rs = null;
		CallableStatement call = null;
		Connection conn = null;
		...
		try {
			...
			rs = (ResultSet) call.getObject(1);
			while (null != rs && rs.next()) {
				Pgv00303 b = new Pgv00303();
				b.setFwtdzl(rs.getString(1));
				b.setXqnm(rs.getString(2));
				listResult.add(b);
				b = null;
			}
		} catch (Exception e) {
