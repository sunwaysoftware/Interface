 ...
 *
 */
public class Pgt00322DAO extends BaseDAO implements IPgt00322DAO {
...
//	private static final String NOTE = "note";						//备注信息
	...
	public boolean GetDeleteCommand(Pgt00322 lcxz) throws Exception {
	...
	public boolean GetDeleteSelCommand(Pgv00322 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
		...
		try {
			...
			tran = session.beginTransaction();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_DELT003221(?,?,?)}");
	...
	@Override
	public boolean GetInsertCommand(Pgt00322 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	...
	@Override
	public boolean GetUpdateCommand(Pgt00322 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	...
	@Override
	public ArrayList<Pgv00322> LoadAll(Pgv00322 lcxz) throws Exception {
		ArrayList<Pgv00322> listResult = new ArrayList<Pgv00322>();
		ResultSet rs = null;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
		try {
			session = getSession();
			conn = super.getConnection();
			call = conn.prepareCall("{call PGSP_GETALLT00322(?,?,?,?,?,?)}");
			//注册输出参数
	 ...
	 * @throws Exception
	 */
	protected Pgv00322 SetVParameters(ResultSet rs) throws Exception {
		Pgv00322 e = new Pgv00322();
	...
	@Override
	public Pgt00322 LoadByPrimaryKey(Pgt00322 lcxz) throws Exception {
		ArrayList<Pgt00322> listResult = new ArrayList<Pgt00322>();
		ResultSet rs = null;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	 ...
	 * @throws Exception
	 */
	protected Pgt00322 SetTParameters(ResultSet rs) throws Exception {
		Pgt00322 e = new Pgt00322();
...
//		//e.setYwdt(rs.getInt(YWDT));
	...
	public boolean ExecuteParamCopy(Pgt00322 lcxz) throws Exception {
		boolean bResult = false;
		CallableStatement call = null;
		Connection conn = null;
		Session session = null;
	...
	@Override
	public OutputStream ExportLXCZSjcx(Pgv00322 lcxz) throws Exception {
	...
	public Pgv00322 ImportExcelData(ArrayList<Pgv00322> ebList) throws Exception {
		...
		try{
			...
			conn = super.getConnection();
			tran = session.beginTransaction();
			call = conn.prepareCall("{call PGSP_ADDT003221(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			for(int i=0; i<ebList.size(); i++){
				Pgv00322 bean = ebList.get(i);
				try {//注册数据参数
					call.registerOutParameter(1, OracleTypes.CURSOR);
					//注册输出参数
					call.setString(2, bean.getSzqy());
					call.setString(3, bean.getXqdm());
					call.setString(4, bean.getFwlx());
					call.setDouble(5, bean.getJzmj());
					call.setShort(6, bean.getZcs());
					call.setShort(7, bean.getLc());
					call.setDate(8, ConvertUtil.utilDateToSqlDate(bean.getJysj()));
					call.setDouble(9, bean.getPgjg());
					call.setString(10, bean.getJcnf());
					call.setString(11, bean.getFwcx());
					call.setString(12, bean.getFwzx());
					call.setString(13, bean.getCd00001Ssgx());
					call.setString(14, bean.getCd00002Czr());
					call.setString(15, bean.getNote());
					call.execute();
