 ...
 *
 */
public class Pgt00335aDAO extends BaseDAO implements IPgt00335aDAO {
	...
	/* (non-Javadoc)
	 * @see com.sunway.dao.IPgt00335aDAO#LoadAll(com.sunway.vo.Pgt00335a)
	 */
	
	@Override
	public ArrayList<Pgt00335a> LoadAll(Pgt00335a bean) throws Exception {
		ArrayList<Pgt00335a> listResult = new ArrayList<Pgt00335a>();
		ResultSet rs = null;
		...
		try {
			...
			call = conn.prepareCall("{call PGSP_GETALLT00335A(?,?,?)}");
			// 注冊輸出參數
	 ...
	 * @throws Exception
	 */
	protected Pgt00335a SetTParameters(ResultSet rs) throws Exception {
		return new Pgt00335a(rs.getString(cd00302Fcid), 
				 rs.getString(cdSlid), 
