...
<script type="text/javascript" src="../scripts/T00001/EDITT00001WH.js"></script>
...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
  <tr>
    <td align="left" valign="top">
		...
		<form id="editForm" action="EDITT00001WH.action" method="post">
			...
			<s:if test='%{ACT == "C"}'>
				<input type="hidden" name="ddlROOTID" id="ddlROOTID" value="<s:property value="viewKey" />" />
			</s:if>
			
			<input type="hidden" id="txtROOTID" name="txtROOTID" class="txtfocus" maxlength="3" size="3" value="<s:property value="t00001Dao.rootid" />" <s:if test='%{ACT!="C"}'>disabled="disabled"</s:if> />
			<s:if test='%{ACT!="C"}'>
			...
			<!--<tr>
				...
				<input type="hidden" id="txtROOTID" name="txtROOTID" class="txtfocus" maxlength="3" size="3" value="<s:property value="t00001Dao.rootid" />"
					...
					<select name="ddlROOTID" id="ddlROOTID" class="txtfocus" <s:if test='%{ACT!="C"}'>disabled="disabled"</s:if>>
						<option value="<s:property value="viewKey" />">请选择...</option>
...
<!--								</div>-->
        ...
        <a href="../xtwh/VIEWT00001WH.action?viewKey=<s:property value="viewKey" />" class="easyui-linkbutton" plain="true" iconCls="icon-back"><s:property value="getText('app.button.back')" />
        </a>
        </div>
        </div>
