...
<script type="text/javascript" src="../scripts/TFC001/VIEWTFC0011.js"></script>
...
$(function(){
	...
	$('#test').datagrid({					
		...
		frozenColumns:[[ 
				 ...
				 {title:'终止',field:'status_zz',width:50,align:'center',formatter:function(value,rec){					
					if(value==1)
						return "已终止";	
					else
						return "<a href=\"javascript:breakService('" + rec.slid + "','" + rec.ssqy+"')\"><img src=\"../images/ico/stop.gif\" title=\"终止\" alt=\"终止\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
				 }}
				/*  ,
	             {title:'退税',field:'status_se',width:60,align:'center',formatter:function(value,rec){
	            	 if(value==1 && rec.status==7)   
	            	     return "<a href=\"javascript:rebateTax('" + rec.slid + "','" + rec.ssqy+"')\"><img src=\"../images/ico/rebate.gif\" title=\"退税\" alt=\"退税\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
	            	 else
	 					return ""; 
	             }} */
			]],
			columns:[[/* {title:'<s:property value="getText('app.xtwh.tfc001.info')"/>',field:'info',width:60,align:'center',formatter:function(value,rec){
						if(value==0)
		           		 return "";
		           	 else if(value==1)
		           		 return "<a href=javascript:Show('../xtwh/DETAILTFC0011.action?SLID=" + rec.slid + "&SSQY=" + rec.ssqy + "',300,420,'反馈说明'); title='点击查看详细信息' ><img src=\"../images/ico/explain.gif\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
					}},*/
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.tfc0011.title')}" /></span>
			</div>
