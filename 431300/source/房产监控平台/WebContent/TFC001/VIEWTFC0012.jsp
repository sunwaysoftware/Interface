...
<script type="text/javascript" src="../scripts/TFC001/VIEWTFC0012.js"></script>
...
$(function(){
	...
	$('#test').datagrid({					
		...
		frozenColumns:[[ 
		                {title:'退税',field:'status_se',width:35,align:'center',formatter:function(value,rec){
		                	if(value==2)
		                		return "<a href=\"VIEWTFC001TSZC.action?SLID=" + rec.slid+"&SSQY=" + rec.ssqy+"\"><img src=\"../images/ico/rebate1.gif\" title=\"退税\" alt=\"退税\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
                            else
		                	return "<a href=\"VIEWTFC001TSZC.action?SLID=" + rec.slid+"&SSQY=" + rec.ssqy+"\"><img src=\"../images/ico/rebate.gif\" title=\"退税\" alt=\"退税\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.tfc0012.title')}" /></span>
			</div>
