...
<script type="text/javascript" src="../scripts/TFC001/VIEWTFC0013.js"></script>
...
$(function(){
	...
	$('#test').datagrid({					
		...
		frozenColumns:[[ 
		                {title:'退回',field:'bg',width:35,align:'center',formatter:function(value,rec){
				              return "<a href=\"javascript:procesErrorData('" + rec.slid + "','" + rec.ssqy+"')\"><img src=\"../images/ico/return.gif\" title=\"退回房产修改\" alt=\"退回\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
			               }}
			]],
			columns:[[
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.tfc0013.title')}" /></span>
			</div>
...
<div id="w2" style="width:310px;height:200px;padding:5px;background: #fafafa;">
	<input type="hidden" name="SLID" id="SLID" />	
	<input type="hidden" name="SSQY" id="SSQY" />
	<textarea name="txtREMARKS" cols="40" rows="7" id="txtREMARKS"></textarea>
</div>
</body>
</html>