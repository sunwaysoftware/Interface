...
<script type="text/javascript" src="../scripts/TFC001/EDITTFC0012.js"></script>
...
<table border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
	<tr>
		...
		<div class="datagrid-title">
				<span class="datagrid-title-text">退税登记</span>
			</div>
		<div id="INFO" class="divConect">
		<div style="min-height: 400px">
		<form action="UPDTFC0012.action" method="post" id="editForm">		
		...
		<a href="VIEWTFC0012.action" class="easyui-linkbutton" plain="true" iconCls="icon-back"><s:property value="getText('app.button.back')" /></a></div>
