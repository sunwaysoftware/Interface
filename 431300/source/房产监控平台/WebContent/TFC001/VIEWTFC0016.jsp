...
<script type="text/javascript" src="../scripts/TFC001/VIEWTFC0016.js"></script>
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.tfc0016.title')}" /></span>
			</div>

		<div class="divtop">
				<form id="findForm" action="EXPTFC0016.action" method="post" target="_blank">		
				    <span>产权人</span>					
