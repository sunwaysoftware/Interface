...
<script type="text/javascript" src="../scripts/TFC001/VIEWTFC001.js"></script>
...
$(function(){
	...
	$('#test').datagrid({					
		...
		frozenColumns:[[ 
				 {title:'完税',field:'edit',width:35,align:'center',formatter:function(value,rec){
						//return "<a href=ADDT00004.action?ACT=U&pk=" + rec.id + "><img src=\"../images/ico/Edit.gif\" alt=\"编辑\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
						return "<a href=\"VIEWTFC001MSZC.action?SLID=" + rec.slid+"&SSQY=" + rec.ssqy+"\"><img src=\"../images/ico/ok.gif\" title=\"完税信息登记\" alt=\"完税\" width=\"16\" height=\"16\" align=\"absmiddle\" /></a>";
    ...
    <td align="left" valign="top">
	   	<div class="ui-widget-content">
			<div class="datagrid-title">
				<span class="datagrid-title-text"><s:property value="%{getText('app.xtwh.tfc001.title')}" /></span>
			</div>

		<div class="divtop">
				<form id="findForm" action="EXPTFC001.action" method="post" target="_blank">		
