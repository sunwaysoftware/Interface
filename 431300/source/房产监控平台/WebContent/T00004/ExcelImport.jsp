...
<form action="../xtwh/GYCFKSXZIMPORT.action" method="post" id="editForm" enctype="multipart/form-data">
	...
	<span id="imgUpload" style="display:none"><img src="../scripts/easyui/themes/default/images/pagination_loading.gif"/>正在上传数据...</span>
		<a href="#" id="uploadBtn" class="easyui-linkbutton" plain="true" iconCls="icon-upload">数据导入</a>
		<a href="../xtwh/VIEWT10054.action" class="easyui-linkbutton" plain="true" iconCls="icon-back"><s:property value="getText('app.button.back')"/></a>
	</div>
	</div>
</div>
</td>
