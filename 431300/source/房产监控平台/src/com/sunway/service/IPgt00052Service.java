 ...
 *
 */
public interface IPgt00052Service {
	...
	/**
	 * 上传RAR或者批量上传时根据用户税收管辖及小区代码号获取该小区所对应所在区域代码
	 * @param v00052
	 * @return
	 * @throws Exception
	 */
	public ArrayList<Pgv00052> LoadSzqyAtUploadPhoto(Pgv00052 v00052)throws Exception;
}
