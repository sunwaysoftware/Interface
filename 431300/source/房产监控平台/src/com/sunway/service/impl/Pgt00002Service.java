...
public class Pgt00002Service implements IPgt00002Service {
	...
	public StringBuffer ExportAll(Pgv00002 user) throws Exception {
		return t00002Dao.ExportAll(user);
	}

	@Override
	public OutputStream ExportUser(Pgv00002 v00002) throws Exception {
		
		return t00002Dao.ExportUserInform(v00002);
	}

	@Override
	public boolean validateUserIdIsExist(Pgv00002 v00002) throws Exception {
		return t00002Dao.validateUserIdIsExist(v00002);
	}
