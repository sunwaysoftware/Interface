...
public class Constant implements Serializable {
	 ...
	 * ******
	 */
	public static final String SYS_LOCK_DATE = "2011-06-01";
	/**
	 * 审核执行完毕
	 */
	 ...
	 * 税额登记执行成功
	 */
	public static final String MSG_SEDJ_EXECR_OK = "app.msg.sedj.execR.ok";
	/**
	 * 税额登记执行失败
	 */
	public static final String MSG_SEDJ_EXECR_NG = "app.msg.sedj.execR.ng";

	/**
	 * 退税登记执行成功
	 */
	public static final String MSG_TSDJ_EXECR_OK = "app.msg.tsdj.execR.ok";
	/**
	 * 退税登记执行失败
	 */
	public static final String MSG_TSDJ_EXECR_NG = "app.msg.tsdj.execR.ng";
}
