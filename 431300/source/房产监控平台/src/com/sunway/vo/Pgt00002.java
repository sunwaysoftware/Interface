...
public class Pgt00002 implements java.io.Serializable {
	...
	private String useridOld;					// 更新时获取的新用户ID
	private String cd00001SsgxOld;				// 更新时获取的新税收管辖
	...
	public String getCd00001SsgxOld() {
		return cd00001SsgxOld;
	}

	public void setCd00001SsgxOld(String cd00001SsgxOld) {
		this.cd00001SsgxOld = cd00001SsgxOld;
	}
